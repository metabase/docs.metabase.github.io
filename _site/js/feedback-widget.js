...
(function() {
  ...
  try {
    document
      .getElementById("feedback-widget-container")
      .classList.remove("hide");
  } catch (e) {
    // If widget is lost to the void, bail.
    return;
  }
  ...
  function handleVote(isHelpful) {
    ...
    return function(ev) {
      ...
      // Hide vote options and show comment form.
      document.getElementById("page-feedback").classList.add("hide");
