...
This page focuses on editing table and column metadata; another page covers [segments and metrics](https://www.metabase.com/docs/v0.42/administration-guide/07-segments-and-metrics).

Or are you instead looking for docs on [models](../users-guide/models.html)?
...
You can use the Data Model page to edit field types for fields in your database. Use the **Type** dropdown menu to select from this [list of options](../users-guide/field-types.html). 

In this same menu, you can also designate a column as the table's **primary key** or **foreign key**.

See the [users guide](../users-guide/field-types.html#list-of-metabase-field-types) for more on types and how they function in Metabase.
