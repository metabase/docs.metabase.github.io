...
**Still Fresh Today** uses [case](../expressions/case) to check if the current date ([now](../expressions/now)) is [between](../expressions-list#between) the dates in **Opened On** and **Finish By**:
