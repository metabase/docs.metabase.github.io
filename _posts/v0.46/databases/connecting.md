...
layout: new-docs
redirect_from:
    - /v0.46/administration-guide/01-managing-databases
    - /v0.46/databases/connections/sql-server
    - /v0.46/administration-guide/databases/h2
    - /v0.46/databases/connections/h2
---
