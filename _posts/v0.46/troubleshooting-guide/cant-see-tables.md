...
If you get an error, see [Troubleshooting database connections](./db-connection).
...
- [Table not found](/learn/debugging-sql/sql-syntax#column-or-table-name-is-not-found-or-not-recognized)
...
If there are only a few people who can't view tables, see [A user group has the wrong access to a table or schema](./data-permissions#a-user-group-has-the-wrong-access-to-a-table-or-schema).
