...
layout: new-docs
redirect_from:
    - /v0.48/administration-guide/01-managing-databases
    - /v0.48/databases/connections/sql-server
    - /v0.48/administration-guide/databases/h2
    - /v0.48/databases/connections/h2
---
