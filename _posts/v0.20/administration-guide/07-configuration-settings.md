...
title: '07 Configuration Settings'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/administration-guide/07-configuration-settings.md'
layout: docs
---
...
If you want to use Slack to enhance the Metabase experience then lets do that now. Let’s learn [how to setup Slack](07-setting-up-slack.html).
