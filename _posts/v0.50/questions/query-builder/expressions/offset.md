...
category: Questions
title: Offset
source_url: 'https://github.com/metabase/metabase/blob/master/docs/questions/query-builder/expressions/offset.md'
layout: new-docs
---
...
With these offsets (the Sums in the "Previous period" column), we can then create [custom columns](../introduction#creating-custom-columns) to calculate things like the difference between yearly Sums:
