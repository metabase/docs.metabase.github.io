...
> Model persistence doesn't work with [data sandboxing](../permissions/data-sandboxes).
...
You can also toggle persistence on or off for individual models. When viewing a model, click on the **...** in the upper right and select **Turn model persistence on/off** (you'll need [Curate access](../permissions/collections#curate-access) to the model's collection to do this).
