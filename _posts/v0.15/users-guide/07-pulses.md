...
title: '07 Pulses'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/users-guide/07-pulses.md'
layout: docs
---
...
### Pick Your Data
Before you can create a pulse, you’ll need to have some [saved questions](05-sharing-answers.html). You can choose up to five of them to put into a single pulse. Click the dropdown to see a list of all your saved questions. You can type in the dropdown to help filter and find the question you’re looking for.
...
Sometimes you’ll need help understanding what data is available to you and what it means. Metabase provides a way for your administrators and data experts to build a [data model reference](08-data-model-reference.html) to help you make sense of your database.
