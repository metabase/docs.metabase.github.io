...
If an administrator has [defined some metrics](../administration-guide/07-segments-and-metrics.html), when you click on the `Ask a question` button in the top bar you'll see a screen like this one:
