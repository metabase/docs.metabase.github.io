...
If you'd like to have your users authenticate with SAML, we offer a paid feature that lets you do just that. [Learn more about authenticating with SAML](16-authenticating-with-saml.html)
...
If you use a SAML-based identity provider for SSO, [learn how to connect it to Metabase](16-authenticating-with-saml.html).