...
Alternatively, without the need to explicitly install the above dependencies, follow the guide [on using Visual Studio Code](deven#developing-with-visual-studio-code.html) and its remote container support.
