...
- Permissions are granted to [groups](04-managing-users.html#groups), not people.
...
[Application permissions](application-permissions.html) (available on paid plans) dictate access to Metabase application-level features, including:
...
- [Managing people and groups](04-managing-users.html)
