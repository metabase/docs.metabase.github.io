...
title: '17 Data-Sandboxes'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/administration-guide/17-data-sandboxes.md'
layout: docs
---
...
1. Get them automatically by connecting to your SAML Single Sign-On (SSO) provider. For instructions on connecting SAML SSO to Metabase, [check out this article](16-authenticating-with-saml.html).
