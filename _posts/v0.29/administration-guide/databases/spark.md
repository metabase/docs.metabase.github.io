...
title: Databases
source_url: 'https://github.com/metabase/metabase/blob/master/docs/administration-guide/databases/spark.md'
layout: docs
---

## Working with SparkSQL in Metabase

Starting in v0.29, Metabase provides a driver for connecting to SparkSQL databases. Under the hood, Metabase uses SparkSQL's
