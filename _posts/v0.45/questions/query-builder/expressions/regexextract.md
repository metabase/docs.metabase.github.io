...
Now, you can use **Campaign Name** in places where you need clean labels, such as [filter dropdown menus](../../../dashboards/filters#creating-a-dropdown-filter), [charts](../../sharing/visualizing-results), and [embedding parameters](../../../embedding/signed-embedding-parameters).
