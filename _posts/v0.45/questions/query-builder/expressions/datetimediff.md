...
category: Questions
title: DatetimeDiff
source_url: 'https://github.com/metabase/metabase/blob/master/docs/questions/query-builder/expressions/datetimediff.md'
layout: new-docs
---
...
3. Turn the "Today" question into a [model](../../../data-modeling/models).
4. Create a [left join](../../query-builder/join) between **Cheese** and the "Today" model on `[Aging Start] <= [Today]`.
...
| [Data type](/learn/databases/data-types-overview#examples-of-data-types) | Works with `datetimeDiff` |
| ------------------------------------------------------------------------------------------------ | ------------------------- |
| String                                                                                           | ❌                        |
| Number                                                                                           | ❌                        |
| Timestamp                                                                                        | ✅                        |
...
If your timestamps are stored as strings or numbers in your database, an admin can [cast them to timestamps](../../../data-modeling/metadata-editing#casting-to-a-specific-data-type) from the Data Model page.
...
Some databases, such as Snowflake and BigQuery, support functions like `DATEDIFF` or `DATE_DIFF`. For more info, check out our list of [common SQL reference guides](/learn/debugging-sql/sql-syntax#common-sql-reference-guides).
...
- [Time series comparisons](/learn/questions/time-series-comparisons)
- [How to compare one time period to another](/learn/dashboards/compare-times)
- [Working with dates in SQL](/learn/sql-questions/dates-in-sql)
