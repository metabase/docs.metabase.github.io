...
layout: new-docs
redirect_from:
    - /v0.45/administration-guide/whitelabeling
    - /v0.45/enterprise-guide/whitelabeling
    - /v0.45/enterprise-guide/customize-embeds
    - /v0.45/embedding/whitelabeling
    - /v0.45/embedding/fonts
    - /v0.45/embedding/customize-embeds
---
