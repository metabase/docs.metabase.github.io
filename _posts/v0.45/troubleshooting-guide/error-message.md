...
- [Table or column "not found" or "not recognized"](/learn/debugging-sql/sql-syntax#column-or-table-name-is-not-found-or-not-recognized).
- [Function does not exist](/learn/debugging-sql/sql-syntax#sql-function-does-not-exist).
