...
layout: new-docs
redirect_from:
    - /v0.47/administration-guide/01-managing-databases
    - /v0.47/databases/connections/sql-server
    - /v0.47/administration-guide/databases/h2
    - /v0.47/databases/connections/h2
---
