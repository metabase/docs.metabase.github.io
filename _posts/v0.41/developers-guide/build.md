...
Alternatively, without the need to explicitly install the above dependencies, follow the guide [on using Visual Studio Code](https://www.metabase.com/docs/v0.41/developers-guide/deven#developing-with-visual-studio-code.html) and its remote container support.
