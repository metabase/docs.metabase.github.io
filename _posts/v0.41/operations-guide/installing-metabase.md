...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/operations-guide/installing-metabase.md'
layout: docs
---

# Installing and Running Metabase

Below we provide links to detailed instructions on how to install and run Metabase in a variety of common configurations. If you're not sure which way is right for you, check out [How to run Metabase in production](/blog/how-to-run-metabase-in-production). 
...
#### [Running on Azure Web Apps](running-metabase-on-azure.html)
