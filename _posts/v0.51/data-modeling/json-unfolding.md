...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/data-modeling/json-unfolding.md'
layout: new-docs
---
...
In the [query builder](../questions/query-builder/introduction), Metabase can't parse JSON in columns, so you can only filter by "Is empty" or "Not empty".
...
- [BigQuery](../databases/connections/bigquery) (always enabled)
