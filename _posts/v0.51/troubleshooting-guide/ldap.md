...
title: LDAP
source_url: 'https://github.com/metabase/metabase/blob/master/docs/troubleshooting-guide/ldap.md'
layout: new-docs
---

# LDAP

Metabase can use LDAP for authentication. [This article][ldap-learn] explains how to set it up, and the guide below will help you troubleshoot if anything goes wrong. If your problem isn't specific to LDAP, go to [our troubleshooting guide for logging in](./cant-log-in).
...
[ldap-learn]: /learn/metabase-basics/administration/permissions/ldap-auth-access-control
