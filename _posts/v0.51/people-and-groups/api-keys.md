...
title: 'API keys'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/people-and-groups/api-keys.md'
layout: new-docs
---
...
We don't version the [Metabase API](../api-documentation). We rarely change API endpoints, and almost never remove them, but if you write code that relies on the API, there's a chance you might have to update your code in the future.
...
- [Metabase API reference](../api-documentation).
