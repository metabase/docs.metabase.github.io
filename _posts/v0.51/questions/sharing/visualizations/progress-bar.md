...
category: Questions
title: 'Progress bars'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/questions/sharing/visualizations/progress-bar.md'
layout: new-docs
---
...
- Progress bars assume that your objective is to _increase_ a metric. If the objective is to decrease or reduce a metric, consider using the [gauge chart](gauge).
