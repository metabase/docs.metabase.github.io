...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/people-and-groups/changing-session-expiration.md
layout: new-docs
redirect_from:
  - /latest/operations-guide/changing-session-expiration
latest: true
---
