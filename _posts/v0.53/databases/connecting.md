...
layout: new-docs
redirect_from:
    - /v0.53/administration-guide/01-managing-databases
    - /v0.53/databases/connections/sql-server
    - /v0.53/administration-guide/databases/h2
    - /v0.53/databases/connections/h2
---
