...
source_url: 'https://github.com/metabase/metabase/blob/v0.27/docs/users-guide/04-asking-questions.md'
layout: docs
---
...
If an administrator has [defined some metrics or segments](../administration-guide/07-segments-and-metrics.html), when you click on the New Question button, you'll see a screen like this one:
...
Once you have an answer to your question, you can now learn more about [visualizing answers](05-visualizing-results.html).
