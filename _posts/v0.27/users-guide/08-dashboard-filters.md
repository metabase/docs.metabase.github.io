...
source_url: 'https://github.com/metabase/metabase/blob/v0.27/docs/users-guide/08-dashboard-filters.md'
layout: docs
---
...
Note that if your dashboard includes cards that were created using the SQL/native query editor, you'll need to add a bit of additional markup to the SQL in those cards in order to use a dashboard filter on them. [Using SQL parameters](13-sql-parameters.html)
