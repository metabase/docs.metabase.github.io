...
title: '10 Pulses'
source_url: 'https://github.com/metabase/metabase/blob/v0.27/docs/users-guide/10-pulses.md'
layout: docs
---
...
### Pick Your Data
Before you can create a pulse, you’ll need to have some [saved questions](06-sharing-answers.html). You can choose up to five of them to put into a single pulse. Click the dropdown to see a list of all your saved questions. You can type in the dropdown to help filter and find the question you’re looking for.
