...
title: Faq
source_url: 'https://github.com/metabase/metabase/blob/v0.27/docs/faq.md'
layout: docs
---
...
[Yes](./users-guide/04-asking-questions.html#using-sql).
...
The primary audience of the GUI querying interface is a non-technical user who doesn't SQL. Advanced users can always [use SQL](./users-guide/04-asking-questions.html#using-sql).
