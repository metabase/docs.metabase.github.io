...
You can also view an x-ray by navigating to a table, field, metric, or segment in the [Data Reference](./12-data-model-reference.html). Just click the x-ray link in the lefthand sidebar.
