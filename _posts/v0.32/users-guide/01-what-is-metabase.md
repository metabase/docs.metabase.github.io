...
* Some [automatic explorations](14-x-rays.html) of your tables that you can look at and save as a dashboard if you like any of them.
...
Once you've created some [dashboards](07-dashboards.html), any of them that you pin will show up on the homepage for all of your teammates, so that when they log in to Metabase they'll know right where to go.
