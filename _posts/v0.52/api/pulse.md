...
category: Api
title: Pulse
source_url: 'https://github.com/metabase/metabase/blob/master/docs/api/pulse.md'
layout: new-docs
summary: "`/api/pulse` endpoints. These are all authenticated. For unauthenticated `/api/pulse/unsubscribe` endpoints,\n  see [[metabase.api.pulse.unsubscribe]].\n\n  Deprecated: will soon be migrated to notification APIs.\n"
---
