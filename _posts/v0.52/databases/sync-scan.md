...
- [Syncs](#how-database-syncs-work) get updated schemas to display in the [Data Browser](/learn/metabase-basics/querying-and-dashboards/data-browser).
...
2. Using an API key: `/api/notify/db/:id`. We created this endpoint so that people could notify their Metabase to sync after an [ETL operation](/learn/grow-your-data-skills/data-landscape/etl-landscape) finishes. To use this endpoint, you must pass an API key by defining the `MB_API_KEY` environment variable.
