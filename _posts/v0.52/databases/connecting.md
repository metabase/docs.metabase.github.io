...
layout: new-docs
redirect_from:
    - /v0.52/administration-guide/01-managing-databases
    - /v0.52/databases/connections/sql-server
    - /v0.52/administration-guide/databases/h2
    - /v0.52/databases/connections/h2
---
