...
layout: new-docs
redirect_from:
    - /v0.52/administration-guide/whitelabeling
    - /v0.52/enterprise-guide/whitelabeling
    - /v0.52/enterprise-guide/customize-embeds
    - /v0.52/embedding/whitelabeling
    - /v0.52/embedding/fonts
    - /v0.52/embedding/customize-embeds
---
