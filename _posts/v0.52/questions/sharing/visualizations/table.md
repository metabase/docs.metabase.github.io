...
category: Questions
title: Tables
source_url: 'https://github.com/metabase/metabase/blob/master/docs/questions/sharing/visualizations/table.md'
layout: new-docs
---

# Tables

The **Table** option is good for looking at tabular data (duh), or for lists of things like users or orders. The visualization options for tables allow you to add, hide, or rearrange fields in the table you're looking at, as well as modify their formatting. Check out [Everything you can do with the table visualization](/learn/metabase-basics/querying-and-dashboards/visualization/table).
