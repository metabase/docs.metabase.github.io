...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/embedding/sdk/quickstart-with-sample-app.md'
layout: new-docs
---
...
- [A Metabase Pro or Enterprise license](/pricing) (If you don't have a licences, check out [this quickstart](./quickstart))
