...
You can already send data to Slack on  a set schedule via [Pulses](./07-pulses) but what about when you need an answer right now? Say hello to Metabot.
...
- [Connect to Slack](./07-pulses) to start using Metabot.
