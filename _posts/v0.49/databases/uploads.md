...
Once you've [enabled uploads](#enabling-uploads), you can [upload files](../exploration-and-organization/collections#uploading-data) in CSV format to a collection in Metabase.
...
If you have a file larger than 50 MB, the workaround here is to split the data into multiple and [append those files to an existing model](../exploration-and-organization/collections#appending-to-a-model-created-by-an-upload).
