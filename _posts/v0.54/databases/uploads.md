...
- [ClickHouse](../developers-guide/partner-and-community-drivers#partner-drivers)
...
If you have a file larger than 50 MB, the workaround here is to split the data into multiple and [append those files to an existing model](../exploration-and-organization/uploads#appending-to-a-model-created-by-an-upload)
