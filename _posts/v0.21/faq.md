...
[Yes](./users-guide/03-asking-questions.html#using-sql). 


### Do I need to know SQL to use Metabase?
[No](./users-guide/03-asking-questions.html)


### Why can't I do X in the Query Builder?

The primary audience of the GUI querying interface is a non-technical user who doesn't SQL. Advanced users can always [use SQL](./users-guide/03-asking-questions.html#using-sql).
