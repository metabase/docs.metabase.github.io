...
source_url: 'https://github.com/metabase/metabase-init/blob/master/docs/administration-guide.md'
---

#Administration Guide
---
If you haven't already installed a copy of Metabase, you'll need to do so.  If you need help doing that, check out our [Installation Guide](http://docs.metabase.com/docs/v0.10.3/v0.10.3/installation-guide).  
...
For each type of database, you'll need the appropriate connection information.  For help finding your database type's connection information, check out our [Installation Guide](http://docs.metabase.com/docs/v0.10.3/v0.10.3/installation-guide).
...
---
*For an in-depth description of Metabase's understanding of metadata and how it uses it, check out our [Metadata Guide](http://docs.metabase.com/docs/v0.10.3/v0.10.3/metadata-guide)*
