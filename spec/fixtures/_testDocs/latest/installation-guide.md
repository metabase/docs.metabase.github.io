...
source_url: 'https://github.com/metabase/metabase-init/blob/master/docs/installation-guide.md'
---
...
Typically, once there is a dedicated analytics database or a datawarehouse, ETL processes become important. Learn more at See the [Data Warehouse Guide](http://docs.metabase.com/docs/v0.10.3/v0.10.3/data-warehousing).
...
* Beanstalk
    * [Elastic Beanstalk Installation Recipe](http://docs.metabase.com/docs/v0.10.3/v0.10.3/installing-on-elastic-beanstalk).
* running a container
