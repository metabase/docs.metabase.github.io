...
title: '04 Visualizing Results'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/users-guide/04-visualizing-results.md'
layout: docs
---
...
Now let's learn about [sharing and organizing your saved questions](05-sharing-answers.html).
