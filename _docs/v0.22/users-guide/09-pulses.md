...
title: '09 Pulses'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/users-guide/09-pulses.md'
layout: docs
---
...
If your team uses Slack to communicate, you can [use Metabot](10-metabot.html) to display your saved questions directly within Slack whenever you want.
