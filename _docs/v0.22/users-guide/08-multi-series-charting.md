...
title: '08 Multi Series Charting'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/users-guide/08-multi-series-charting.md'
layout: docs
---
...
Pulses let you send out a group of saved questions on a schedule via email or Slack. [Get started with Pulses](09-pulses.html).
