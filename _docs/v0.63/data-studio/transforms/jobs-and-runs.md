...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/data-studio/transforms/jobs-and-runs.md'
layout: new-docs
...
1. Make sure you have [permissions to edit transforms](./transforms-overview#permissions-for-transforms).
...
If your Metabase is [set up to send email](../../configuring-metabase/email), Metabase will let people know when transforms fail.
