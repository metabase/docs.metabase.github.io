...
layout: new-docs
redirect_from:
    - /docs/v0.63/operations-guide/changing-password-complexity
...
You can change your password in [Account settings](account-settings).

## Reset a password

See [Resetting passwords](managing#resetting-someones-password).
