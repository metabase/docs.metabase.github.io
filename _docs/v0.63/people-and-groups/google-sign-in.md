...
layout: new-docs
redirect_from:
    - /docs/v0.63/administration-guide/10-single-sign-on
    - /docs/v0.63/people-and-groups/google-and-ldap
---
...
> On [paid plans](/pricing/), you're [charged for each active account](/how-billing-works#what-counts-as-a-user-account).
