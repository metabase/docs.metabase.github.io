...
layout: new-docs
redirect_from:
    - /docs/v0.63/users-guide/04-asking-questions
    - /docs/v0.63/users-guide/06-sharing-answers
---
...
- **+ New > SQL/Native query** to create a question using the native/SQL query editor. See [Native editor](../questions/native-editor/writing-sql).
  ...
  Even if you know SQL, you should still check out the [graphical query builder](./query-builder/editor), as you can use it to build [interactive charts](../questions/visualizations/drill-through).
