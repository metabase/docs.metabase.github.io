...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/questions/native-editor/optional-variables.md'
layout: new-docs
...
That last clause uses a [field filter](./field-filters) (note the lack of a column in the `AND` clause). When using a field filter, you _must_ exclude the column in the query; you need to map the variable in the side panel.
