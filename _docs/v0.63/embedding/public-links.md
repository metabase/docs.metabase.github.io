...
layout: new-docs
redirect_from:
    - /docs/v0.63/administration-guide/12-public-links
    - /docs/v0.63/embedding/12-public-links
---
...
To embed a dashboard, see [guest embedding](./guest-embedding).
...
See docs for the [export format endpoint](/docs/latest/api#tag/public/GET/public/card/{uuid}/query/{export-format}).

## Simulating drill-through with public links

Metabase's automatic [drill-through](../questions/visualizations/drill-through) won't work on public dashboards because public links don't give people access to your raw data.
...
If you'd like to create a secure embed that prevents people from changing filter names or values, check out [guest embedding](./guest-embedding).
