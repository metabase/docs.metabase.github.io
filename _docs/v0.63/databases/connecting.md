...
layout: new-docs
redirect_from:
    - /docs/v0.63/administration-guide/01-managing-databases
    - /docs/v0.63/databases/connections/sql-server
    - /docs/v0.63/administration-guide/databases/h2
    - /docs/v0.63/databases/connections/h2
    - /docs/v0.63/databases/connections
---
...
As of version 46.6.4, Metabase [no longer supports H2 connections](/blog/vulnerability-post-mortem). But Metabase still ships with an H2 database to include an embedded application database.
...
If you've deleted the Metabase [Sample Database](/glossary/sample-database), go to **Admin** > **Databases** and click **Bring the Sample Database back**.
