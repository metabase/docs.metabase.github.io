...
layout: new-docs
redirect_from:
    - /docs/v0.63/administration-guide/whitelabeling
    - /docs/v0.63/enterprise-guide/whitelabeling
    - /docs/v0.63/enterprise-guide/customize-embeds
    - /docs/v0.63/embedding/whitelabeling
    - /docs/v0.63/embedding/fonts
    - /docs/v0.63/embedding/customize-embeds
