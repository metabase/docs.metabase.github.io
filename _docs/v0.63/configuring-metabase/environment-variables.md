...
layout: new-docs
redirect_from:
    - /docs/v0.63/operations-guide/environment-variables
---
...
- Type: boolean
- Default: `true`
- [Exported as](../installation-and-operation/serialization): `ai-features-enabled`.
- [Configuration file name](./config-file): `ai-features-enabled`
...
- Type: boolean
- Default: `false`
- [Exported as](../installation-and-operation/serialization): `analytics-pii-retention-enabled`.
- [Configuration file name](./config-file): `analytics-pii-retention-enabled`
...
- Type: string
- Default: `,`
- [Exported as](../installation-and-operation/serialization): `csv-field-separator`.
- [Configuration file name](./config-file): `csv-field-separator`
...
- Type: boolean
- Default: `false`
- [Exported as](../installation-and-operation/serialization): `custom-viz-enabled`.
- [Configuration file name](./config-file): `custom-viz-enabled`
...
- Type: boolean
- Default: `true`
- [Exported as](../installation-and-operation/serialization): `embedded-metabot-enabled`.
- [Configuration file name](./config-file): `embedded-metabot-enabled`
...
- Type: integer
- Default: `10000`
- [Exported as](../installation-and-operation/serialization): `fingerprint-max-fields-per-table`.
...
- [Configuration file name](./config-file): `jwt-attribute-tenant-attributes`
...
- [Configuration file name](./config-file): `llm-anthropic-api-base-url`
...
- Type: string
- Default: `null`
- [Configuration file name](./config-file): `llm-anthropic-api-key`
...
- [Configuration file name](./config-file): `llm-anthropic-model`
...
- Type: string
- Default: `null`
- [Configuration file name](./config-file): `llm-azure-api-base-url`
...
- Type: string
- Default: `null`
- [Configuration file name](./config-file): `llm-azure-api-key`
...
- Type: string
- Default: `null`
- [Configuration file name](./config-file): `llm-bedrock-access-key-id`
...
- Type: string
- Default: `us-east-1`
- [Configuration file name](./config-file): `llm-bedrock-region`
...
- Type: string
- Default: `null`
- [Configuration file name](./config-file): `llm-bedrock-secret-access-key`
...
- Type: string
- Default: `null`
- [Configuration file name](./config-file): `llm-bedrock-session-token`
...
- Type: integer
- Default: `5000`
- [Configuration file name](./config-file): `llm-connection-timeout-ms`
...
- Type: integer
- Default: `4096`
- [Configuration file name](./config-file): `llm-max-tokens`
...
- [Configuration file name](./config-file): `llm-mistral-api-base-url`
...
- Type: string
- Default: `null`
- [Configuration file name](./config-file): `llm-mistral-api-key`
...
- [Configuration file name](./config-file): `llm-openai-api-base-url`
...
- Type: string
- Default: `null`
- [Configuration file name](./config-file): `llm-openai-api-key`
...
- Type: string
- Default: `gpt-5.4`
- [Configuration file name](./config-file): `llm-openai-model`
...
- [Configuration file name](./config-file): `llm-openrouter-api-base-url`
...
- Type: string
- Default: `null`
- [Configuration file name](./config-file): `llm-openrouter-api-key`
...
- Type: integer
- Default: `100`
- [Configuration file name](./config-file): `llm-rate-limit-per-ip`
...
- Type: integer
- Default: `20`
- [Configuration file name](./config-file): `llm-rate-limit-per-user`
...
- Type: integer
- Default: `60000`
- [Configuration file name](./config-file): `llm-request-timeout-ms`
...
- [Configuration file name](./config-file): `llm-zai-api-base-url`
...
- Type: string
- Default: `null`
- [Configuration file name](./config-file): `llm-zai-api-key`
...
- Type: boolean
- Default: `true`
- [Exported as](../installation-and-operation/serialization): `metabot-enabled`.
- [Configuration file name](./config-file): `metabot-enabled`
...
- Type: double
- Default: `0.1`
- [Configuration file name](./config-file): `query-caching-early-refresh-ratio`
...
- Type: boolean
- Default: `false`
- [Configuration file name](./config-file): `remote-sync-transforms`
...
- Type: integer
- Default: `10000`
- [Exported as](../installation-and-operation/serialization): `scan-max-fields-per-table`.
...
- Type: boolean
- Default: `true`
- [Configuration file name](./config-file): `slack-connect-user-provisioning-enabled`
...
- Type: integer
- Default: `10000`
- [Exported as](../installation-and-operation/serialization): `sync-max-fields-per-table`.
...
- Type: boolean
- Default: `false`
- [Configuration file name](./config-file): `transforms-enabled`
...
See [Observability with Prometheus](../installation-and-operation/observability-with-prometheus).
