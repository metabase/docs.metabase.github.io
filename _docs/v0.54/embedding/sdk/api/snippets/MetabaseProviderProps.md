...
| <a id="eventhandlers"></a> `eventHandlers?`     | [`SdkEventHandlersConfig`](./api/SdkEventHandlersConfig)                                                                                      | See [Global event handlers](/docs/v0.54/embedding/sdk/config#global-event-handlers).     |
...
| <a id="pluginsconfig"></a> `pluginsConfig?`     | [`MetabasePluginsConfig`](./api/MetabasePluginsConfig)                                                                                        | See [Plugins](/docs/v0.54/embedding/sdk/plugins).                                        |
| <a id="theme"></a> `theme?`                     | [`MetabaseTheme`](./api/MetabaseTheme)                                                                                                        | See [Appearance](/docs/v0.54/embedding/sdk/appearance).                                  |
