...
layout: new-docs
redirect_from:
    - /v0.54/administration-guide/01-managing-databases
    - /v0.54/databases/connections/sql-server
    - /v0.54/administration-guide/databases/h2
    - /v0.54/databases/connections/h2
---
