...
layout: new-docs
redirect_from:
    - /v0.54/administration-guide/whitelabeling
    - /v0.54/enterprise-guide/whitelabeling
    - /v0.54/enterprise-guide/customize-embeds
    - /v0.54/embedding/whitelabeling
    - /v0.54/embedding/fonts
    - /v0.54/embedding/customize-embeds
---
