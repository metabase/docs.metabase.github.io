...
layout: new-docs
redirect_from:
    - /docs/v0.54/administration-guide/whitelabeling
    - /docs/v0.54/enterprise-guide/whitelabeling
    - /docs/v0.54/enterprise-guide/customize-embeds
    - /docs/v0.54/embedding/whitelabeling
    - /docs/v0.54/embedding/fonts
    - /docs/v0.54/embedding/customize-embeds
---
