...
| `initialSqlParameters`  | `Record<string, string \| string[]>`                                 | (optional) A mapping of [SQL parameters names](../../questions/native-editor/sql-parameters) to parameter values, such as `{ product_id: "42" }`.                                                                                                                                                               |
