...
category: Questions
title: 'SQL snippets'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/questions/native-editor/sql-snippets.md'
layout: new-docs
redirect_from:
    - /docs/v0.52/users-guide/sql-snippets
---
...
**SQL snippets** are reusable bits of SQL or native queries. Anyone with permissions to the [SQL editor](./writing-sql) can create and edit snippets, which are then available for all SQL authors.
...
Some plans contain additional functionality for organizing snippets into folders and setting permissions on those folders. See our [docs on SQL snippet folders and permissions](../../permissions/snippets).
