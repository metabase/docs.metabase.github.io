...
layout: new-docs
redirect_from:
    - /docs/v0.52/users-guide/15-alerts
---
...
_Requires a [bar, line, or area chart](./visualizations/line-bar-and-area-charts) with a goal line._
...
_Requires the [progress bar visualization](./visualizations/progress-bar)._
...
- Admins can remove all alerts created by a Metabase user and unsubscribe that user from all other alerts from the [People menu in Admin settings](../../people-and-groups/managing#unsubscribe-from-all-subscriptions-and-alerts).
