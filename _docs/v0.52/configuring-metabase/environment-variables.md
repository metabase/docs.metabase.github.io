...
layout: new-docs
redirect_from:
    - /docs/v0.52/operations-guide/environment-variables
---
...
Also see the [Customizing Jetty web server](../configuring-metabase/customizing-jetty-webserver) documentation page.
