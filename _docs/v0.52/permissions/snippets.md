...
layout: new-docs
redirect_from:
    - /docs/v0.52/enterprise-guide/sql-snippets
---
...
This article covers **SQL snippet folders**, which allow you to organize and set permissions on [SQL snippets](../questions/native-editor/sql-snippets).
...
You can create a SQL snippet folder from the **Snippets** menu in the [SQL editor](../questions/native-editor/writing-sql).
...
On [some plans](/pricing), when creating a SQL snippet, you'll also see an additional option to add that snippet to an existing folder (the **Folder this should be in** option).
