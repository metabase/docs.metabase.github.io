...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/troubleshooting-guide/server-logs.md'
layout: new-docs
---
...
[log-level]: ../configuring-metabase/log-configuration
[scale]: /learn/metabase-basics/administration/administration-and-operation/metabase-at-scale
