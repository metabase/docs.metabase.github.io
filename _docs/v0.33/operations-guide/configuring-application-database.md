...
*  Metabase provides limited support for migrating from H2 to Postgres or MySQL if you decide to upgrade to a more
   production-ready database. See [Migrating from H2 to MySQL or Postgres](http://www.metabase.com/docs/v0.33/operations-guide/migrating-from-h2) for more details.
