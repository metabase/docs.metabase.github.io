...
If you or someone else wrote a SQL query that includes [variables](13-sql-parameters.html), your question might have filter widgets at the top of the screen. These let you modify and filter the SQL query before it's run, changing the results you might get.
...
Now that you have an answer to your question, you can now learn more about [visualizing answers](05-visualizing-results.html).
