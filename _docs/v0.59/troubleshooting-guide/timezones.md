...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/troubleshooting-guide/timezones.md'
layout: new-docs
---
...
1. Check the [report timezone setting](../configuring-metabase/localization#set-default-instance-report-timezone) from **Admin** > **Settings** > **Localization**.
...
1. Look at every time field your question uses in the [Data Model Reference](../exploration-and-organization/data-model-reference) and see if any of them are simply a "Date" field.
