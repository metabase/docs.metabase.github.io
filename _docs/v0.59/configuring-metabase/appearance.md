...
layout: new-docs
redirect_from:
    - /docs/v0.59/administration-guide/whitelabeling
    - /docs/v0.59/enterprise-guide/whitelabeling
    - /docs/v0.59/enterprise-guide/customize-embeds
    - /docs/v0.59/embedding/whitelabeling
    - /docs/v0.59/embedding/fonts
    - /docs/v0.59/embedding/customize-embeds
