...
title: 'Custom maps'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/configuring-metabase/custom-maps.md'
layout: new-docs
redirect_from:
    - /docs/v0.59/administration-guide/20-custom-maps
...
Metabase sends the map tile server URL to the browser, including in [embeds](../embedding/start) and [public links](../embedding/public-links). Anyone who can view a map can read the URL and any key in it.
