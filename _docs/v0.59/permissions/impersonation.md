...
People in groups with impersonation access cannot create Slack [alerts](../questions/alerts) or [dashboard subscriptions](../dashboards/subscriptions). Email alerts and subscriptions are still available. See [Notification permissions](./notifications).
