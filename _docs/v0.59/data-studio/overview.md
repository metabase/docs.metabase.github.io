...
- **[Data structure](./data-structure)**: Add table metadata to make tables easier to work with.
...
- **[Dependency graph](./dependency-graph)**\*: A visual map of how your content connects, so you can understand the impact of changes before you make them.
- **[Dependency diagnostics](./dependency-diagnostics)**\*: See which items have broken dependencies, or that aren't used.
- **[Transforms](./transforms/transforms-overview)**: Wrangle your data in Metabase, write the query results back to your database, and reuse them in Metabase as sources for new queries. Transforms are optional—Metabase queries your connected databases directly without them.
