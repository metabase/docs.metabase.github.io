...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/embedding/embedded-analytics-js.md
layout: new-docs
summary: >-
  Getting started with Embedded Analytics JS for embedding Metabase entities
