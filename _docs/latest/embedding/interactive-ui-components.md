...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/embedding/interactive-ui-components.md
layout: new-docs
description: >-
  Customize the UI components in your interactive Metabase embed by adding
