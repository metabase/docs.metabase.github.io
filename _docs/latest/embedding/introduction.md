...
| Display interactive [filter widgets](https://metabase.com/glossary/filter_widget)                                           | ✅                                              | ✅                                        | ✅                              | ✅                                     |
| Export results\*                                                                                                                | ✅                                              | ✅                                        | ✅                              | ✅                                     |
...
| Self-serve via [query builder](https://metabase.com/glossary/query_builder)                                                 | ✅                                              | ✅                                        | ❌                              | ❌                                     |
...
\* Each embedding type allows data downloads by default, but only [Pro and Enterprise](https://metabase.com/pricing/) plans can disable data downloads.
