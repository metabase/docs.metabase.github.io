...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/embedding/browser-reference.md
layout: new-docs
summary: >-
  Reference for the metabase-browser web component attributes and the
  CollectionBrowser SDK props.
latest: true
---
