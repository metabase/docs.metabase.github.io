...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/embedding/full-app-ui-components.md
layout: new-docs
description: >-
  Customize the UI components in your full app Metabase embed by adding
  parameters to the embedding URL.
redirect_from:
...
> For more granular control of embedded components, consider using [Modular embedding](./modular-embedding) instead of full app embedding - it's an improved, more customizable option for embedding Metabase elements.
