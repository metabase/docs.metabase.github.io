...
| <a id="visibleentitytypes"></a> `visibleEntityTypes?`       | (`"question"` \| `"model"` \| `"collection"` \| `"dashboard"`)[]                                                                                             | The types of entities that should be visible. If not provided, all entities will be shown.                                                                                                                                                                                                                                             |
