...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/embedding/sdk/api/snippets/MetabaseProviderProps.md
layout: new-docs
latest: true
---
...
| <a id="theme"></a> `theme?`                     | [`MetabaseTheme`](./api/MetabaseTheme)                                                                                                        | See [Appearance](/docs/latest/embedding/sdk/appearance).                                  |
