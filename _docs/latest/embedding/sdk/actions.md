...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/embedding/sdk/actions.md'
layout: new-docs
summary: >-
  Trigger Metabase actions from your embedded application with the `useAction`
  hook.
latest: true
---
...
With the `useAction` hook, you can trigger an [action](../../actions/introduction) when someone clicks a button or submits a form in your app.
...
- [Hook](./api/useAction)
- [Return type](./api/UseActionResult)
...
- [AnyActionResult](./api/AnyActionResult)
- [ActionResultForKind](./api/ActionResultForKind)
- [ActionResultForCreate](./api/ActionResultForCreate)
- [ActionResultForUpdate](./api/ActionResultForUpdate)
- [ActionResultForDelete](./api/ActionResultForDelete)
- [ActionResultForBulk](./api/ActionResultForBulk)
- [ActionResultForSql](./api/ActionResultForSql)
...
- [ActionExecuteError](./api/ActionExecuteError)
