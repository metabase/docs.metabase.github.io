...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/embedding/dashboard-reference.md
layout: new-docs
summary: >-
  Reference for the metabase-dashboard web component attributes, the
  StaticDashboard, InteractiveDashboard, and EditableDashboard SDK props, and
  the dashboard creation components.
latest: true
---
...
For how to set all this up, check out [Embed a dashboard](./dashboard).
...
`StaticDashboard` embeds a [view-only dashboard](./dashboard#embed-a-view-only-dashboard): a lightweight component that displays results without letting people interact with the data.

- [Component](./sdk/api/StaticDashboard)
- [Props](./sdk/api/StaticDashboardProps)
...
`InteractiveDashboard` embeds an [interactive dashboard](./dashboard#embed-an-interactive-dashboard), with drill-downs, click behaviors, and the ability to view and click into questions.

- [Component](./sdk/api/InteractiveDashboard)
- [Props](./sdk/api/InteractiveDashboardProps)
...
`EditableDashboard` does everything `InteractiveDashboard` does, and also lets people [edit the dashboard](./dashboard#react-sdk-editable-dashboard): add and update questions, layout, and content.

- [Component](./sdk/api/EditableDashboard)
- [Props](./sdk/api/EditableDashboardProps)
...
`CreateDashboardModal` lets people [create a new dashboard](./dashboard#createdashboardmodal) from your app.

- [Component](./sdk/api/CreateDashboardModal)
- [Props](./sdk/api/CreateDashboardModalProps)
...
`useCreateDashboardApi` [creates a dashboard](./dashboard#usecreatedashboardapi) without Metabase's own modal, so you can build your own UI.

- [Hook](./sdk/api/useCreateDashboardApi)
- [Options](./sdk/api/CreateDashboardValues)
...
See [Customize the menu on dashboard cards](./dashboard#customize-the-menu-on-dashboard-cards-react-sdk-only).
