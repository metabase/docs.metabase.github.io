...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/permissions/row-and-column-security.md
layout: new-docs
summary: >-
  Control what data different groups can see by filtering rows and columns based
  on user attributes. Useful for multi-tenant analytics.
redirect_from:
