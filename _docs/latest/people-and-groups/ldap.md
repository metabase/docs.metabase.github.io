...
title: LDAP
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/people-and-groups/ldap.md
layout: new-docs
latest: true
---
...
Manually assigning people to [groups](./managing#groups) in Metabase after they've logged in via SSO can get tedious. Instead, you can take advantage of the groups that already exist in your LDAP directory by enabling [group mappings](https://metabase.com/learn/metabase-basics/administration/permissions/ldap-auth-access-control#group-management).
...
- [Using LDAP for authentication and access control](https://metabase.com/learn/metabase-basics/administration/permissions/ldap-auth-access-control).
