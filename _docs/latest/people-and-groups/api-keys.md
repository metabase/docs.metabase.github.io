...
title: API keys
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/people-and-groups/api-keys.md
layout: new-docs
latest: true
---
...
- [Working with the Metabase API](https://metabase.com/learn/metabase-basics/administration/administration-and-operation/metabase-api).
