...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/installation-and-operation/observability-with-prometheus.md
layout: new-docs
latest: true
---
...
Download the latest [Metabase JAR](https://metabase.com/start/oss/), and run Metabase using an environment variable to specify the Prometheus server port:
