...
We recommend [Metabase Cloud](https://metabase.com/pricing/) (obviously).
...
If you'd like help with setting up Metabase (or building out your data stack in general), check out the [professional services we offer](https://metabase.com/product/professional-services).
