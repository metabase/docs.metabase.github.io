...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/installation-and-operation/running-metabase-as-service.md
layout: new-docs
redirect_from:
...
- You have a [Java Runtime Environment (JRE)](./running-the-metabase-jar-file#1-install-java-jre) installed on your system
...
For production setups, you must set up a [PostgreSQL or MySQL/MariaDB application database](./configuring-application-database) as Metabase's application database.
...
[Environment variables](../configuring-metabase/environment-variables) let you configure and customize your Metabase instance.

We'll create a file to store these environment variables, which we'll use when creating the systemd service for Metabase.

This command will create an environment variable file at `/home/metabase/.env`, which you should update to point to your [PostgreSQL application database](./configuring-application-database):
