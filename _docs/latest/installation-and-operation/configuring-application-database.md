...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/installation-and-operation/configuring-application-database.md
layout: new-docs
redirect_from:
