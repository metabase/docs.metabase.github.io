...
Metabase doesn't sync any of your data. What it stores in Git are [YAML files](./serialization#example-of-a-serialized-question) describing your analytics content. Your actual data stays in your databases and never leaves your Metabase.
...
- Your [Library](../data-studio/library)
- [Transforms](../data-studio/transforms/transforms-overview)
- Any top-level collection under Our Analytics.
- If you use [tenants](../embedding/tenants), you can also sync [shared collections](../embedding/tenants#collection-types).
...
Remote Sync stores your content as [YAML files](./serialization#example-of-a-serialized-question) in your Git repository. Each dashboard, question, model, and document becomes a YAML file that can be reviewed in pull requests and versioned like code.

### Remote Sync excludes table metadata

Table metadata doesn't sync. Table metadata includes things like table names, column types, descriptions, and visibility settings. If you need to version table metadata, use [serialization](./serialization) instead.
...
To version your data transformation logic, you can sync your [Transforms](../data-studio/transforms/transforms-overview), including all your tags and jobs. Some things to keep in mind:
