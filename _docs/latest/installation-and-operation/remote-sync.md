...
layout: new-docs
description: >-
  Version control your dashboards, questions, and models with Git. Sync content
  between development and production instances automatically.
latest: true
---
...
Remote Sync lets you develop analytics content in a special collection in a development Metabase and automatically deploy it to a read-only production Metabase through Git. If you use [Tenants](../embedding/tenants), you can also sync shared collections.
...
6. (Optionally) If you have [multi-tenant user strategy enabled](../embedding/tenants#enable-multi-tenant-strategy), you can also choose which [shared collection](../embedding/tenants#changing-tenant-strategy) to sync.
...
Sometimes you might want synced content to appear at the top level of your navigation rather than nested under the Synced Collection. If you use [Tenants](../embedding/tenants), you can accomplish that with synced shared collections.
