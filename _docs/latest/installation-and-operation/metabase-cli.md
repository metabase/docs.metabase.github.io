...
title: Metabase CLI
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/installation-and-operation/metabase-cli.md
layout: new-docs
summary: >-
  The Metabase CLI (mb) is a command-line client that drives a Metabase instance
  over its API. Use it yourself, or hand it to an AI agent with the metabase-cli
  skill.
latest: true
---
