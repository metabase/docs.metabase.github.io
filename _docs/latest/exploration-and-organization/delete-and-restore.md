...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/exploration-and-organization/delete-and-restore.md
layout: new-docs
summary: >-
  You can move questions, dashboards, models, and metrics to Trash where they
  can be restored or permanently deleted. Deleting items affects related content
  like dashboards and subscriptions. Other entities in Metabase can be deleted
  or archived, but won't show up in Trash.
latest: true
---
...
Snippets can be archived and unarchived. See [Archiving snippets](../questions/native-editor/snippets#archive-snippets). You won't see archived snippets in Trash. Snippets can't be permanently deleted.

## Deleting segments

Segments can be retired. See [Retiring Segments](../data-modeling/segments#editing-and-retiring-segments). Retiring segments is permanent.
