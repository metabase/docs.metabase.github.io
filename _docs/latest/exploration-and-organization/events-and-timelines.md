...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/exploration-and-organization/events-and-timelines.md
layout: new-docs
redirect_from:
...
You can't add a timeline with events to the [Library](../data-studio/library).
