...
layout: new-docs
summary: >-
  Configure Metabot settings, including which collections Metabot can access,
  and learn tips for improving Metabot's performance through data modeling and
  metadata.
latest: true
---
...
Toggle [Metabot](./metabot) on or off for your Metabase or embedded contexts. Both Metabot and Embedded Metabot are enabled by default.
