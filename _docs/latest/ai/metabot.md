...
- **Managing alerts.** [Metabot in Slack](./metabot-slack) can create alerts and dashboard subscriptions, but can't modify or delete existing ones.
...
Slack Metabot directly or @mention it in a channel to ask questions about your data. See [Metabot in Slack](./metabot-slack).
