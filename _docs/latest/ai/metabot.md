...
- Create a chart using the [query builder](../questions/query-builder/editor) from a natural language query.
- Generate SQL in the [native editor](../questions/native-editor/writing-sql) from natural language.
