...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/ai/sql-generation.md'
layout: new-docs
summary: >-
  Bring your own API key to generate SQL from natural language in your
...
> One-shot SQL generation with your own API key is only available on self-hosted Metabases. For Metabase Cloud, check out [Metabot](./metabot).

Bring your own API key to generate SQL from natural language in the [native editor](../questions/native-editor/writing-sql).
...
1. Open the [native editor](../questions/native-editor/writing-sql).
...
- [The native/SQL editor](../questions/native-editor/writing-sql)
- [Metabot](./metabot)
