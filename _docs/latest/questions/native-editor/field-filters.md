...
title: Field filters
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/questions/native-editor/field-filters.md
layout: new-docs
summary: >-
  Field filters let you create smart filter widgets for your SQL questions by
  connecting variables to database fields. Where possible, prefer field filters
  to basic variables.
latest: true
---
