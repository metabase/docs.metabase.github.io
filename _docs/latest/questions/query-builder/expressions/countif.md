...
title: CountIf
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/questions/query-builder/expressions/countif.md
layout: new-docs
latest: true
---
...
> [Aggregations](../expressions-list#aggregations) like `CountIf` should be added to the query builder's [**Summarize** menu](../../query-builder/summarizing-and-grouping) > **Custom Expression** (scroll down in the menu if needed).
