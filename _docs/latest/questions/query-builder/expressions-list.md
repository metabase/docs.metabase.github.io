...
Check out our tutorial on [custom expressions in the query builder](https://metabase.com/learn/metabase-basics/querying-and-dashboards/questions/custom-expressions) to learn more.
