...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/questions/query-builder/summarizing-and-grouping.md
layout: new-docs
summary: >-
  Learn how to summarize and group your data in Metabase's query builder to
  calculate metrics like counts, sums, and averages across different dimensions.
latest: true
---
...
If your admins have created any named [metrics](../../data-modeling/metrics) or [measures](../../data-studio/measures) that are specific to your company or organization, they will be in this dropdown under the **Metrics** or **Measures** section. These might be things like your company’s official way of calculating revenue.
