...
title: Box plots
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/questions/visualizations/box-plot.md
layout: new-docs
summary: >-
  Box plots, also known as box and whisker plots, show the distribution of
  numeric data across groups, displaying the median, quartiles, and outliers.
latest: true
---
...
If your question returns a single aggregated value per group (like total orders per year), you'll want a [bar chart](./line-bar-and-area-charts) instead.

Compared to [scatter plots](./scatterplot-or-bubble-chart), which show individual data points, box plots summarize the distribution so you can quickly spot differences between groups.
