...
To visualize your results in the format of a map of the world broken out by country, your result must contain a column with [two-letter ISO country codes](https://metabase.com/glossary/country_code), like "US" or "BR", for example:
