...
For more, check out [How to create a pivot table to summarize your data](https://metabase.com/learn/metabase-basics/querying-and-dashboards/visualization/how-to-create-pivot-tables).
