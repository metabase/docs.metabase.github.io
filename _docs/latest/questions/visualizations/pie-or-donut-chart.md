...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/questions/visualizations/pie-or-donut-chart.md
layout: new-docs
redirect_from:
  - /latest/questions/sharing/visualizations/pie-or-donut-chart
latest: true
---
