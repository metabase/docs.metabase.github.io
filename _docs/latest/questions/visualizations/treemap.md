...
title: Treemaps
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/questions/visualizations/treemap.md
layout: new-docs
summary: >-
  Visualize hierarchical data as nested rectangles, where a metric sets the size
  of each rectangle.
latest: true
---
