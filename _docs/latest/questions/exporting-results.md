...
layout: new-docs
summary: >-
  Exporting your Metabase questions and dashboards as CSV, Excel, JSON, PDF, or
  PNG files.
redirect_from:
...
- For CSV exports, you can increase this limit with an environment variable: [`MB_DOWNLOAD_ROW_LIMIT`](../configuring-metabase/environment-variables#mb_download_row_limit). Increasing this limit, however, may impact your Metabase's performance.
