...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/troubleshooting-guide/sql.md
layout: new-docs
latest: true
---
...
- [I don't know the SQL variable type](https://metabase.com/learn/grow-your-data-skills/learn-sql/working-with-sql/sql-variables).
