...
To reset password for your Metabase Store account, [contact support](https://metabase.com/help-premium).

## No access to Metabase login page

If you're not a Metabase admin, you'll have to tag them for help here.

1. Check that you have the correct [site URL](../configuring-metabase/settings) from **Settings** > **Admin settings** > **General**.
...
If you've forgotten your Metabase Cloud admin password, you can [contact support](https://metabase.com/help-premium) to reset the password.
