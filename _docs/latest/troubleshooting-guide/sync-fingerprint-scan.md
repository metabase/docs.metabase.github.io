...
- Clean up the data further in your [ETL or ELT](https://metabase.com/learn/grow-your-data-skills/data-landscape/etl-landscape) process.
...
- [Reduce the frequency of sync queries](../databases/sync-scan#scheduling-database-syncs).

To speed up **scans**:

- [Reduce the frequency of scans, or disable scans entirely](../databases/sync-scan#scheduling-database-scans).
