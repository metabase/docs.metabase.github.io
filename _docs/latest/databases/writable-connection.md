...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/databases/writable-connection.md
layout: new-docs
summary: >-
...
Once writable connection is removed, Metabase will revert to using the main connection for [features that need write access](#features-that-use-writable-connection), so your main connection will need to have appropriate database permissions, see [Users, roles, and privileges](./users-roles-privileges)
...
Your writable connection will need to have the privileges required for these operations. See [Users, roles, and privileges](./users-roles-privileges).

## Limitations

- Writable connection can't be used with [database routing](../permissions/database-routing).
