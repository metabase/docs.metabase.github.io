...
For operations that require write access, we recommend using separate [writable connections](./writable-connection).
...
- Give the `metabase_writer` role to the user used for your database connection. We recommend using a [writable connection](./writable-connection) and only granting this role to the user used for the writable connection.
...
- Give the `metabase_model_persistence` role to the user used for your database connection. We recommend using a [writable connection](./writable-connection) and only granting this role to the user used for the writable connection.
...
- Give the `metabase_transforms` role to the user used for your database connection. We recommend using a [writable connection](./writable-connection) and only granting this role to the user used for the writable connection.
...
You can [upload CSVs](../databases/uploads) to supported databases. Metabase's database user should have write access (`INSERT`, `UPDATE`, `DELETE`) to the schema where you want to store the uploads. We recommend using a [writable connection](./writable-connection) and only granting write access to the user used for the writable connection.
...
- [Writable connections](./writable-connection)
