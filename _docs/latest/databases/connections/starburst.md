...
title: Starburst
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/databases/connections/starburst.md
layout: new-docs
description: >-
  Learn how to connect Metabase to your Starburst or Trino database, including
  connection settings, SSL configuration, and database sync options.
latest: true
---
