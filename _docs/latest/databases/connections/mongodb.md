...
title: MongoDB
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/databases/connections/mongodb.md
layout: new-docs
redirect_from:
  - /latest/administration-guide/databases/mongodb
latest: true
---
...
If you are using Metabase Cloud, you'll need to whitelist [Metabase Cloud IP addresses](/docs/latest/cloud/ip-addresses-to-whitelist) in your Atlas cluster. If you are using self-hosted Metabase, you'll need to whitelist the IP of your Metabase instance.
