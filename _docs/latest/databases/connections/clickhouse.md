...
title: ClickHouse
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/databases/connections/clickhouse.md
layout: new-docs
description: >-
  Learn how to connect Metabase to your ClickHouse database, including
  connection settings, database selection, and SSL configuration.
latest: true
---
