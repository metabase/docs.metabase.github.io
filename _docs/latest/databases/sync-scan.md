...
layout: new-docs
summary: >-
  Learn how Metabase stays in sync with your database by running periodic
  queries to update metadata, sample field values, and compute stats.
latest: true
---
...
Once the queries are done running, you can view and edit the synced metadata from **Admin** > **Table Metadata**. For more info, see [editing metadata](../data-modeling/metadata-editing).
