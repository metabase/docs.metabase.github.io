...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/usage-and-performance-tools/audit.md
layout: new-docs
redirect_from:
  - /latest/enterprise-guide/audit
latest: true
---

# Auditing tools

> Auditing tools are deprecated. Instead, check out the (much better) [Usage analytics](./usage-analytics).
