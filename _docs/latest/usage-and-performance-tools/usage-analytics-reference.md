...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/usage-and-performance-tools/usage-analytics-reference.md
layout: new-docs
summary: >-
  A list of the dashboards and models included in the Usage Analytics
  collection.
latest: true
---
...
For an overview of access, retention, and custom reports, see [Usage analytics](usage-analytics).

For more on AI usage data, see [AI usage auditing](../ai/usage-auditing).
