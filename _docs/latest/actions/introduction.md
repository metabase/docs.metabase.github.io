...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/actions/introduction.md'
layout: new-docs
latest: true
---
...
- Actions are unavailable for public dashboards and dashboards in [guest embeds](../embedding/guest-embedding). To use actions in embeds, you can use [modular embedding](../embedding/modular-embedding) with SSO or [full app embedding](../embedding/full-app-embedding).
