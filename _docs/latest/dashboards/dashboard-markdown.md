...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/dashboards/dashboard-markdown.md
layout: new-docs
summary: >-
  Add context to your dashboards with text and heading cards, including
  formatted text, images, dividers, and filter values.
latest: true
---
...
1. [Add a filter](../dashboards/filters) to your dashboard.
...
If your admin has [allowed domains for images](../configuring-metabase/settings#allowed-domains-for-images), you can add an image to a dashboard. Add a text card and use Markdown image syntax:
