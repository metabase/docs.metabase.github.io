...
To manually label field or table names in Metabase, check out the [Table Metadata](../data-modeling/metadata-editing) section in your admin panel. Metadata in the Table Metadata can be further curated in [models](../data-modeling/models).
