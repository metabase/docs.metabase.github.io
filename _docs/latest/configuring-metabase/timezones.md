...
title: Timezones
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/configuring-metabase/timezones.md
layout: new-docs
redirect_from:
...
- If you want to change your Metabase Cloud timezone, please [contact support](https://metabase.com/help-premium).
