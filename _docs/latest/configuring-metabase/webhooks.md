...
Before people can send alerts to a webhook, an admin or someone with [settings access](../permissions/application#settings-access) will need to create a webhook to target.
