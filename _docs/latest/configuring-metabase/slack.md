...
title: Set up Slack
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/configuring-metabase/slack.md
layout: new-docs
redirect_from:
...
In order to send [subscriptions](../dashboards/subscriptions) and [alerts](../questions/alerts) to private Slack channels, you must first add the Metabase app to the private channel.
