...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/data-studio/managing-tables.md
layout: new-docs
summary: >-
...
You can replace every occurrence of a table as a data source with another table. See [Replace data sources](./dependencies/replace-data-sources).
...
Segments are saved filters on a table that people can use in the query builder. See [Segments](./segments).

## Measures

Measures are saved aggregations on a table that people can use in the query builder. See [Measures](./measures).

## Further reading

- [Table metadata editing](../data-modeling/metadata-editing)
- [Segments](./segments)
- [Measures](./measures)
