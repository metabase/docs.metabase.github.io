...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/data-studio/dependencies/replace-data-sources.md
layout: new-docs
summary: >-
  Admins can swap out a table, model, or question and replace it with a
  different one across your entire Metabase.
latest: true
---
...
- Metabase uses the [dependency graph](./graph) to identify all content that depends on the original data source. "Data source" here could be a table, model, or question queried by another entity.
...
- **Original data source isn't used in any [row or column security policies](../../permissions/row-and-column-security)**.
...
- If replacing a table, that **original table can't be a target of a Metabase's [semantic foreign keys](../../data-modeling/semantic-types)** from other tables.
...
- [Questions and models referenced from SQL questions](../../questions/native-editor/referencing-saved-questions-in-queries)
- Field filters
...
- [Links](../../dashboards/introduction#link-cards) and [custom destinations](../../dashboards/interactive#custom-destinations) on dashboards;
- Targets for [actions](../../actions/introduction).
