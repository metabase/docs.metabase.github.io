...
- To **execute** transforms on a database, people additionally need to have the [Transform permissions](../../permissions/data) for that database.
...
> Code generation for transforms requires [Metabot to be enabled](../../ai/settings#enable-ai-features) and the **Transforms** add-on.
...
1. Make sure you have [permissions to edit transforms](../../permissions/data).
...
Before converting models into transforms, review [Replacing data sources](../dependencies/replace-data-sources) docs for overview and limitations of the process.
