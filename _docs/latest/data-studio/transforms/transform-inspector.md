...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/data-studio/transforms/transform-inspector.md
layout: new-docs
summary: >-
  Analyze how your transforms process data by inspecting input and output
  shapes, join behavior, and column distributions.
latest: true
---
...
- [Transforms overview](transforms-overview)
- [Query-based transforms](query-transforms)
