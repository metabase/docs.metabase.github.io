...
title: Python runner
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/data-studio/transforms/python-runner.md
layout: new-docs
summary: >-
  Configure self-hosted Python execution environment to run Python transforms in
  Metabase.
latest: true
---
...
> Self-hosted Python transforms require self-hosted Pro or Enterprise plan with the [Advanced transforms add-on](addons).
