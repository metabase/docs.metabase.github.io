...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/data-studio/transforms/addons.md
layout: new-docs
summary: >-
  Metabase transforms come in two flavors - basic transforms for basic
  query-based functionality, and advanced transforms for Python workflows,
  transform inspector, and other functionality.
latest: true
---
