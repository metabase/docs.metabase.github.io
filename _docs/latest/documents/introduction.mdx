...
import Counter from '../_includes/Counter.astro';
import TestSvg from '../_includes/svgs/test-svg.svg';
import TestMdx from '../_includes/test-mdx.mdx';
import TestMd from '../_includes/test-md.md';
