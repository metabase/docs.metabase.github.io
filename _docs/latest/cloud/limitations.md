...
Metabase Cloud doesn't support [community database drivers](../developers-guide/community-drivers), or file-based databases (SQLite), because there's currently no file storage available.
