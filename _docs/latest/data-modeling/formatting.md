...
layout: new-docs
summary: >-
  Configure how dates, numbers, currencies, and text display in Metabase at
  global, field, and question levels.
redirect_from:
...
The options you'll see here will depend on the field's data type and its [semantic type](./semantic-types).
