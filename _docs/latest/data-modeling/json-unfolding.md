...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/data-modeling/json-unfolding.md
layout: new-docs
summary: >-
  Learn how to unfold JSON columns into separate fields that you can filter on
