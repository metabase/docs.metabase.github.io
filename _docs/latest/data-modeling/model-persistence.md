...
The cron scheduler uses the [Report Timezone](../configuring-metabase/localization#report-timezone) if selected. Otherwise the scheduler will use the System Timezone (which defaults to GMT in [Metabase Cloud](https://metabase.com/cloud/)).
