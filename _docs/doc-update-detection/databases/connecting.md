...
redirect_from:
    - /docs/doc-update-detection/administration-guide/01-managing-databases
    - /docs/doc-update-detection/databases/connections/sql-server
    - /docs/doc-update-detection/administration-guide/databases/h2
    - /docs/doc-update-detection/databases/connections/h2
---
