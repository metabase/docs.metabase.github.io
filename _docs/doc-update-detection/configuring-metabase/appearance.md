...
redirect_from:
    - /docs/doc-update-detection/administration-guide/whitelabeling
    - /docs/doc-update-detection/enterprise-guide/whitelabeling
    - /docs/doc-update-detection/enterprise-guide/customize-embeds
    - /docs/doc-update-detection/embedding/whitelabeling
    - /docs/doc-update-detection/embedding/fonts
    - /docs/doc-update-detection/embedding/customize-embeds
---
