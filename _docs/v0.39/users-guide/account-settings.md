...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/users-guide/account-settings.md'
layout: docs
---
...
You can set your first and last names, change your email address, and set your language. See our list of [supported languages](../faq/general/what-languages-can-be-used-with-metabase.html#currently-available-languages).
...
If you're having trouble logging in, see our [How do I reset my password](../faq/using-metabase/how-do-i-reset-my-password.html).
