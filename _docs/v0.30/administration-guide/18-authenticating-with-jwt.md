...
title: '18 Authenticating-With-JWT'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/administration-guide/17-authenticating-with-jwt.md'
layout: docs
---
...
Find out how to create user groups and define what data they can access in the [next section](05-setting-permissions.html).
