...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/embedding/ai-agent-resources.md'
layout: new-docs
...
- [Summary of embedding docs, with links](/docs/llms.txt).
- [The full embedding docs](/docs/llms-embedding-full.txt).
...
- [Upgrading the modular embedding SDK](./sdk/upgrade)
