...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/embedding/authentication.md'
layout: new-docs
summary: 'Adding SSO with JWT or SAML for authenticating modular embeds.'
redirect_from:
    - /docs/master/embedding/sdk/authentication
---
...
To set up JWT SSO, you'll need [a Metabase Pro or Enterprise license](/pricing/).
...
To use SAML single sign-on with modular embedding, you'll need to set up SAML in both your Metabase and your Identity Provider (IdP). See the docs on [SAML-based authentication](../people-and-groups/authenticating-with-saml).
