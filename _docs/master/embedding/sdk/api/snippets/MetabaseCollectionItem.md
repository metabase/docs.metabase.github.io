...
| <a id="last-edit-info"></a> `last-edit-info?`     | \{ `email`: `string`; `first_name`: `string` \| `null`; `id`: [`SdkUserId`](./api/SdkUserId); `last_name`: `string` \| `null`; `timestamp`: `string`; \}                  |
...
| <a id="type"></a> `type?`                         | \| `"instance-analytics"` \| `"trash"` \| `"remote-synced"` \| `"library"` \| `"library-models"` \| `"library-metrics"` \| `"model"` \| `"question"` \| `"metric"` \| `null` |
