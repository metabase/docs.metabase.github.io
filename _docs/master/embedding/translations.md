...
For now, translations are only available for [guest embed](./static-embedding). Translations aren't available for SSO-based modular embedding or full app embedding.
