...
To restrict data in guest embeds for specific people or groups, use [locked parameters](./static-embedding-parameters#restricting-data-in-a-static-embed-with-locked-parameters).
