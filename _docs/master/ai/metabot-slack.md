...
- **Manage notifications**: Create [subscriptions](../dashboards/subscriptions) and [alerts](../questions/alerts) from within a channel. Metabot can find an answer and subscribe you to it in one go (though Metabot won't create new questions or dashboards).
