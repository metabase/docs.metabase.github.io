...
layout: new-docs
redirect_from:
    - /docs/master/users-guide/dashboard-subscriptions
    - /docs/master/enterprise-guide/dashboards-subscriptions
---
...
You can also send subscriptions to private channels, but that requires additional configuration, see [Sending alerts and subscriptions to private Slack channels](../configuring-metabase/slack#sending-alerts-and-subscriptions-to-private-slack-channels).
