...
layout: new-docs
redirect_from:
    - /docs/master/users-guide/07-dashboards
---
...
3. Choose which [collections](../exploration-and-organization/collections) the dashboard should go in.
...
To get some charts on a dashboard, you'll need to [create questions](../questions/introduction) (Metabase word for chart or query) and then add them, to the dashboard.
