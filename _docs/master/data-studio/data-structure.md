...
Table visibility layer can be used as a tool to improve user experience of people working in you Metabase, and it should _not be used to control access_ - use [data permissions](../permissions/data) to control access instead.
