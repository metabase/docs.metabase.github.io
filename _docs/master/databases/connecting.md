...
layout: new-docs
redirect_from:
    - /master/administration-guide/01-managing-databases
    - /master/databases/connections/sql-server
    - /master/administration-guide/databases/h2
    - /master/databases/connections/h2
---
