...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/databases/encrypting-details-at-rest.md'
layout: new-docs
redirect_from:
    - /docs/master/operations-guide/encrypting-database-details-at-rest
---
...
2. Set your secret key as the environment variable `MB_ENCRYPTION_SECRET_KEY`. On self-hosted [Pro and Enterprise plans](/pricing/) plans, you can also set this using the [config file](../configuring-metabase/config-file).
