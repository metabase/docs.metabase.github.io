...
[Transforms](../data-studio/transforms/transforms-overview) let Metabase write query results back to your database. We suggest that you create a dedicated schema for your transforms. Metabase's database user will need to be able to create and drop transform tables.
