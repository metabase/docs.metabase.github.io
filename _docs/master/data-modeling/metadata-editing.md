...
Descriptions are displayed in Metabase's [data reference](../exploration-and-organization/data-model-reference) and tooltips when viewing the table. Descriptions help people find the right table for their use case.
