...
> Prefer [Transforms](../data-studio/transforms/transforms-overview) instead of models. Models remain supported for now, but will be deprecated in future versions of Metabase.
