...
- Save metrics to [collections](../exploration-and-organization/collections), including the [Library](../data-studio/library).
...
See [content verification](../exploration-and-organization/content-verification). Prefer using [Library metrics](../data-studio/library#metrics) instead of content verification.
