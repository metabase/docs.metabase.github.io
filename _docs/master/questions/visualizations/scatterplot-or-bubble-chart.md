...
layout: new-docs
redirect_from:
    - /docs/master/questions/sharing/visualizations/scatterplot-or-bubble-chart
---
...
> You can't set [alerts](../alerts) on goal lines in scatterplots or bubble charts.
...
- If you only have one numeric value to plot, or if you want to show how a value changes over time, consider a [bar chart, histogram, or line chart](./line-bar-and-area-charts) instead.
- Scatterplots can become hard to read with very large datasets because of overlapping dots. For large datasets, consider aggregating your data, or using a [heat map](./pivot-table#using-pivot-tables-as-heatmaps) or [box plot](./box-plot) instead.
- You can't set [alerts](../alerts) on goal lines in scatterplots or bubble charts.
