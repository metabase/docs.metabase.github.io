...
redirect_from:
    ...
    - /docs/master/questions/visualizations
---
...
[Box plots](./box-plot) show the distribution of numeric data, displaying the median, quartiles, and outliers for each group.
