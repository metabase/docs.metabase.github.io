...
category: Questions
title: Numbers
source_url: 'https://github.com/metabase/metabase/blob/master/docs/questions/visualizations/numbers.md'
layout: new-docs
redirect_from:
    - /docs/master/questions/sharing/visualizations/numbers
---
...
If you want to display the change in the number from period to period, you can use the [Trend chart](../visualizations/trend) instead.
...
1. Build a query that returns at least one number. You can build it either in the [query builder](../query-builder/editor) or in the [native query editor](../native-editor/writing-sql).
