...
On Metabase Pro and Enterprise plans, you can also version control most entities in Metabase, see [Remote Sync](../installation-and-operation/remote-sync).
...
1. Go to your transform in [Data studio](../data-studio/transforms/transforms-overview).
...
1. Go to your transform in [Data studio > Transforms](../data-studio/transforms/transforms-overview).
2. Click the **three dots** icon and select **History**.
3. Click the **back arrow** beside a version to revert your item to that point in time.

## History for segments and measures

1. Go to the table source for the segment or metrics in [Data studio > Data Structure](../data-studio/data-structure).
