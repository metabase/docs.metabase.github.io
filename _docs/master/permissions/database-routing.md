...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/permissions/database-routing.md'
layout: new-docs
...
- [Athena](../databases/connections/athena): Only routing between different connections, e.g. different buckets, roles, or catalogs is supported
