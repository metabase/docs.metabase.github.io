...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/permissions/row-and-column-security-examples.md'
layout: new-docs
redirect_from:
    - /docs/master/permissions/row-and-column-security-examples
---
...
6. **Create a collection that is only viewable by Admins.**. Call it "Admin collection". We'll use this collection to store SQL questions that we use to secure tables in examples 2 and 3. See [Collection permissions](./collections).
