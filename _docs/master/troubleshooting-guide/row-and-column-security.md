...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/troubleshooting-guide/row-and-column-security.md'
layout: new-docs
redirect_from:
    - /docs/master/troubleshooting-guide/sandboxing
---
