...
2. Check if you can connect to the data warehouse from another client using the machine that you’re running Metabase on.
   ...
   - If you're running Metabase Cloud, check that you've [whitelisted our IP addresses](../cloud/ip-addresses-to-whitelist).
...
2. If you're running Metabase Cloud, check that you've [whitelisted our IP addresses](../cloud/ip-addresses-to-whitelist).
