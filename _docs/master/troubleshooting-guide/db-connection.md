...
layout: new-docs
redirect_from:
    - /docs/master/troubleshooting-guide/datawarehouse
---
...
2. Check if you can connect to the data warehouse from another client using the machine that you’re running Metabase on.
   ...
   - If you're running Metabase Cloud, check that you've [whitelisted our IP addresses](/docs/latest/cloud/ip-addresses-to-whitelist).
...
2. If you're running Metabase Cloud, check that you've [whitelisted our IP addresses](/docs/latest/cloud/ip-addresses-to-whitelist).
