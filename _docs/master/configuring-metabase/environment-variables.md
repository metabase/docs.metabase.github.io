...
- Type: boolean
- Default: `false`
- [Exported as](../installation-and-operation/serialization): `embedding-hub-production-embed-snippet-created`.
- [Configuration file name](./config-file): `embedding-hub-production-embed-snippet-created`
...
- Type: boolean
- Default: `false`
- [Exported as](../installation-and-operation/serialization): `embedding-hub-test-embed-snippet-created`.
- [Configuration file name](./config-file): `embedding-hub-test-embed-snippet-created`
