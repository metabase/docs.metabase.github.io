...
People can also override these localization options for specific fields or questions. For more info, see [Formatting](../data-modeling/formatting).
...
You can set the default language (also called the "instance language") across your Metabase UI, system [emails](./email), [dashboard subscriptions](../dashboards/subscriptions), and [alerts](../questions/alerts).
...
Note that people can also override these localization options for specific fields or questions. For more info, see [Formatting](../data-modeling/formatting).
...
You can choose how should currency fields be displayed by default (you can configure _which_ fields should be displayed as currency in table metadata or in question formatting setting, see [Formatting](../data-modeling/formatting) )
