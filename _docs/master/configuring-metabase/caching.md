...
layout: new-docs
redirect_from:
    - /docs/master/administration-guide/14-caching
    - /docs/master/enterprise-guide/cache
---
...
> Questions run by [impersonated users](../permissions/impersonation) will never return cached results; they'll always rerun the queries against the database.
