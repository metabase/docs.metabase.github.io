...
layout: new-docs
redirect_from:
    - /docs/v0.56/administration-guide/01-managing-databases
    - /docs/v0.56/databases/connections/sql-server
    - /docs/v0.56/administration-guide/databases/h2
    - /docs/v0.56/databases/connections/h2
    - /docs/v0.56/databases/connections
---
