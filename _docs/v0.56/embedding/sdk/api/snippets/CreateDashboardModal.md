...
category: Embedding
title: CreateDashboardModal
source_url: 'https://github.com/metabase/metabase/blob/master/docs/embedding/sdk/api/snippets/CreateDashboardModal.md'
layout: new-docs
---
...
| Parameter | Type                                                              |
| :-------- | :---------------------------------------------------------------- |
| `props`   | [`CreateDashboardModalProps`](./api/CreateDashboardModalProps) |
