...
layout: new-docs
redirect_from:
    - /docs/v0.56/administration-guide/whitelabeling
    - /docs/v0.56/enterprise-guide/whitelabeling
    - /docs/v0.56/enterprise-guide/customize-embeds
    - /docs/v0.56/embedding/whitelabeling
    - /docs/v0.56/embedding/fonts
    - /docs/v0.56/embedding/customize-embeds
---
