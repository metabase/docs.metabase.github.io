...
layout: new-docs
redirect_from:
    - /docs/v0.51/enterprise-guide/saml-keycloak
---
...
5. (Optional) Disable key signing for SSO client. See [settings for signing SSO requests](/docs/latest/people-and-groups/authenticating-with-saml#settings-for-signing-sso-requests-optional).
