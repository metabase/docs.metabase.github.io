...
By default, the question is shown in the [default layout](./questions#customizing-interactive-questions) for interactive questions.
...
See [customizing interactive questions](./questions#customizing-interactive-questions) for an example layout.
