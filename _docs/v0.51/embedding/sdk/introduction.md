...
- [Metabase Pro or Enterprise subscription or free trial](/pricing/).
...
See more about the [CLI quickstart](./quickstart-cli).

We also have a [quickstart with a sample app that uses JWT](./quickstart).
...
- [Quickstart with CLI and your data](./quickstart-cli)
- [Questions](./questions)
