...
layout: new-docs
redirect_from:
    - /docs/v0.51/administration-guide/13-embedding
---
...
With the [Embedding SDK](./sdk/introduction), you can embed individual Metabase components with React (like standalone charts, dashboards, the query builder, and more). You can manage access and interactivity per component, and you have advanced customization for seamless styling.
...
| Action                                                                                                                          | [Embedding SDK](./sdk/introduction) | [Interactive](./interactive-embedding) | [Static](./static-embedding) | [Public](../questions/sharing/public-links) |
| ------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- | ----------------------------------------- | ------------------------------- | ---------------------------------------------- |
...
[Interactive embedding](./interactive-embedding) requires authentication via single sign-on (SSO), so you'll need to set that up both in your Metabase and in your application's server. Check out our [Interactive embedding quick start](/docs/v0.51/embedding/interactive-embedding-quick-start-guide).
