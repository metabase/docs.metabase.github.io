...
layout: new-docs
redirect_from:
    - /v0.51/administration-guide/01-managing-databases
    - /v0.51/databases/connections/sql-server
    - /v0.51/administration-guide/databases/h2
    - /v0.51/databases/connections/h2
---
