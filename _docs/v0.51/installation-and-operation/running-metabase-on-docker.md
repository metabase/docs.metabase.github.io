...
layout: new-docs
redirect_from:
    - /docs/v0.51/operations-guide/running-metabase-on-docker
---
...
Use this quick start if you have a [license token](../paid-features/activating-the-enterprise-edition) for a [Pro or Enterprise version](/pricing) of Metabase, and you want to run Metabase locally. See below for instructions on [running Metabase in production](#production-installation).
