...
layout: new-docs
redirect_from:
    - /v0.51/administration-guide/whitelabeling
    - /v0.51/enterprise-guide/whitelabeling
    - /v0.51/enterprise-guide/customize-embeds
    - /v0.51/embedding/whitelabeling
    - /v0.51/embedding/fonts
    - /v0.51/embedding/customize-embeds
---
