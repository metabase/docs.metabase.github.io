...
layout: new-docs
redirect_from:
    - /docs/v0.51/administration-guide/whitelabeling
    - /docs/v0.51/enterprise-guide/whitelabeling
    - /docs/v0.51/enterprise-guide/customize-embeds
    - /docs/v0.51/embedding/whitelabeling
    - /docs/v0.51/embedding/fonts
    - /docs/v0.51/embedding/customize-embeds
---
