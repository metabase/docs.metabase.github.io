...
layout: new-docs
redirect_from:
    - /docs/v0.51/users-guide/03-basic-exploration
---
...
[Pro](/product/pro) and [Enterprise](/product/enterprise) plans include the ability to filter for [verified models and metrics](#verified-items).
