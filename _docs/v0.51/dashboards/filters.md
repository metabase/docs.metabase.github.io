...
layout: new-docs
redirect_from:
    - /docs/v0.51/users-guide/08-dashboard-filters
---
...
> Time grouping parameter widget can only be connected to questions built with the [graphical query builder](../questions/query-builder/introduction).
...
To learn more about linked filters, check out [Linking filters in dashboards](/learn/metabase-basics/querying-and-dashboards/dashboards/linking-filters).
