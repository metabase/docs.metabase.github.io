...
layout: new-docs
redirect_from:
    - /docs/v0.51/administration-guide/07-segments-and-metrics
    - /docs/v0.51/data-modeling/segments-and-metrics
---
...
- [Pro](/product/pro) and [Enterprise](/product/enterprise) plans include the ability to mark metrics as verified.
