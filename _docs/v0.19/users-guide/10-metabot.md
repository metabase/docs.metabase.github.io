...
title: '10 Metabot'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/users-guide/10-metabot.md'
layout: docs
---

## Getting answers in Slack with Metabot

You can already send data to Slack on  a set schedule via [Pulses](09-pulses.html) but what about when you need an answer right now? Say hello to Metabot.
...
See [Setting up Slack](https://metabase.com/docs/v0.15.1/administration-guide/07-setting-up-slack) for more information.
...
- [Connect to Slack](09-pulses.html) to start using Metabot.
...
Sometimes you’ll need help understanding what data is available to you and what it means. Metabase provides a way for your administrators and data experts to build a [data model reference](11-data-model-reference.html) to help you make sense of your data.
