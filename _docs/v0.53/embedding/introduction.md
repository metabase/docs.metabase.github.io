...
layout: new-docs
redirect_from:
    - /docs/v0.53/administration-guide/13-embedding
---
...
[Interactive embedding](./interactive-embedding) requires authentication via single sign-on (SSO), so you'll need to set that up both in your Metabase and in your application's server. Check out our [Interactive embedding quick start](/docs/v0.53/embedding/interactive-embedding-quick-start-guide).
