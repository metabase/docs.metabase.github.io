...
layout: new-docs
redirect_from:
    - /docs/v0.47/embedding/signed-embedding-parameters
---
...
6. Add or update the code on your server to [match the code generated by Metabase](./static-embedding#previewing-the-server-code-for-an-embed).
...
7. Add or update the code on your server to [match the code generated by Metabase](./static-embedding#previewing-the-server-code-for-an-embed).
