...
- [SQL query contains table aliases](../questions/native-editor/sql-parameters#table-aliases).
...
- [I don't know the SQL variable type](/learn/sql-questions/sql-variables#the-different-types-of-variables-available-for-native-sql-queries).
