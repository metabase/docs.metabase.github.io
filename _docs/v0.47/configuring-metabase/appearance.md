...
layout: new-docs
redirect_from:
    - /docs/v0.47/administration-guide/whitelabeling
    - /docs/v0.47/enterprise-guide/whitelabeling
    - /docs/v0.47/enterprise-guide/customize-embeds
    - /docs/v0.47/embedding/whitelabeling
    - /docs/v0.47/embedding/fonts
    - /docs/v0.47/embedding/customize-embeds
---
