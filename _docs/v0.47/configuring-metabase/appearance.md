...
layout: new-docs
redirect_from:
    - /v0.47/administration-guide/whitelabeling
    - /v0.47/enterprise-guide/whitelabeling
    - /v0.47/enterprise-guide/customize-embeds
    - /v0.47/embedding/whitelabeling
    - /v0.47/embedding/fonts
    - /v0.47/embedding/customize-embeds
---
