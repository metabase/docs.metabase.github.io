...
layout: new-docs
redirect_from:
    - /docs/v0.47/administration-guide/01-managing-databases
    - /docs/v0.47/databases/connections/sql-server
    - /docs/v0.47/administration-guide/databases/h2
    - /docs/v0.47/databases/connections/h2
---
...
As of version 46.6.4, Metabase [no longer supports H2 connections](/blog/security-incident-summary). But Metabase still ships with an H2 database to include an embedded application database, as well as to provide some sample data out of the box.
