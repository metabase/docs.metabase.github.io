...
layout: new-docs
redirect_from:
    - /docs/v0.47/administration-guide/12-public-links
    - /docs/v0.47/embedding/12-public-links
    - /docs/v0.47/questions/sharing/public-links
---
...
For more information about the option to **Embed this item in an application**, see the docs on [static embedding](../../embedding/static-embedding).
...
If you'd like to create a secure embed that prevents people from changing filter names or values, check out [static embedding](../../embedding/static-embedding).
