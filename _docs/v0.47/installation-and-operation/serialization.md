...
layout: new-docs
redirect_from:
    - /docs/v0.47/enterprise-guide/serialization
---
...
For more on Metabase settings, see [Configuring Metabase](../configuring-metabase/start)
...
Before exporting, you can also run a Metabase command to [drop entity IDs](./commands#drop-entity-ids).
