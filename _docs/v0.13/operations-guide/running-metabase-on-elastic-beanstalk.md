...
[Launch Metabase on Elastic Beanstalk](http://downloads.metabase.com/v0.13/launch-aws-eb.html)
...
https://s3.amazonaws.com/downloads.metabase.com/v0.13/metabase-aws-eb.zip
...
* Upload a new Application Version
	* Click the `Upload` button on the upper right side of the listing
		* Give the new version a name, ideally including the Metabase version number (e.g. v0.13)
