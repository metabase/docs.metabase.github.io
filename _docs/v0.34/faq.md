...
[Yes](users-guide/writing-sql.html).

### Do I need to know SQL to use Metabase?

[No](users-guide/04-asking-questions.html)

### Does Metabase support SQL Joins?

Yes. Joins were introduced in Metabase version 0.33 and can be used in the [Notebook-editor](users-guide/custom-questions.html).
...
The primary audience of the GUI querying interface is a non-technical user who doesn't SQL. Advanced users can always [use SQL](users-guide/writing-sql.html).
...
If you're sure you've found a bug, please [open an issue](https://github.com/metabase/metabase/issues/new/choose). Otherwise, try checking out the [troubleshooting guide](troubleshooting/start.html) first to see if the answer to your problem is there.
...
- [Public links](administration-guide/12-public-links.html) let you share or embed charts with simplicity.
- A powerful [application embedding](administration-guide/13-embedding.html) let you to embed and customize charts in your own web applications.
