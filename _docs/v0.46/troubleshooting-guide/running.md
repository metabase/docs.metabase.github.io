...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/troubleshooting-guide/running.md'
layout: new-docs
---
...
Make sure you're using a Java version of 11 or higher. For more info, see [Java versions](../installation-and-operation/java-versions#check-installed-version).
...
If you see an error regarding file permissions, like Metabase being unable to read a SQLite database or a custom GeoJSON map file, check out the section "Metabase can't read to/from a file or directory" in our [Docker troubleshooting guide](./docker).
