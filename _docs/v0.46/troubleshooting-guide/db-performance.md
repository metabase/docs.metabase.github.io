...
1. [Reschedule or disable Metabase syncs and scans](../databases/sync-scan).
...
2. [Sync the updated columns](../databases/sync-scan#manually-syncing-tables-and-columns) to bring the changes into Metabase.
