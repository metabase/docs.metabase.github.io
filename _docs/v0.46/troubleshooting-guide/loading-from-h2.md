...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/troubleshooting-guide/loading-from-h2.md'
layout: new-docs
---
...
**Root cause:** You are trying to [migrate](../installation-and-operation/migrating-from-h2) the app database from H2 to a production database such as PostgreSQL or MySQL/MariaDB using the `load-from-h2` command, but this has failed because the database filename is incorrect with an error message like:
...
[serialization-learn]: /learn/administration/serialization
