...
layout: new-docs
redirect_from:
    - /v0.46/administration-guide/whitelabeling
    - /v0.46/enterprise-guide/whitelabeling
    - /v0.46/enterprise-guide/customize-embeds
    - /v0.46/embedding/whitelabeling
    - /v0.46/embedding/fonts
    - /v0.46/embedding/customize-embeds
---
