...
layout: new-docs
redirect_from:
    - /docs/v0.46/administration-guide/02-setting-up-email
---
...
You might also want to specify [approved domains for notifications](./settings#approved-domains-for-notifications).
