...
layout: new-docs
redirect_from:
    - /docs/v0.46/administration-guide/08-configuration-settings
---
...
To manually label field or table names in Metabase, check out the [Data Model](../data-modeling/metadata-editing) section in your admin settings. Metadata in the Data Model can be further curated in [models](../data-modeling/models).
