...
layout: new-docs
redirect_from:
    - /docs/v0.46/administration-guide/10-single-sign-on
---
...
> On [paid plans](/pricing), you're [charged for each additional account](/docs/latest/cloud/how-billing-works#what-counts-as-a-user-account).
