...
layout: new-docs
redirect_from:
    - /docs/v0.46/users-guide/collections
---
...
If you just want to organize _your_ favorite items, you should [bookmark them](./exploration#bookmarks) (only you can see your bookmarks).
