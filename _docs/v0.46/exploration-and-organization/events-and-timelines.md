...
layout: new-docs
redirect_from:
    - /docs/v0.46/users-guide/events-and-timelines
---
...
Anyone with [view access](../permissions/collections) to a collection can view the collection's events and timelines.
