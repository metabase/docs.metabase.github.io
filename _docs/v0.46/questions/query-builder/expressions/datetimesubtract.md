...
**On My Way** uses [case](../expressions/case) to check if the current datetime ([now](../expressions/now)) is [between](../expressions-list#between) the datetimes in **Arrive By** and **Depart At**:
