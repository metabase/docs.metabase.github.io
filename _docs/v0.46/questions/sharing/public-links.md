...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/questions/sharing/public-links.md'
layout: new-docs
redirect_from:
    - /docs/v0.46/administration-guide/12-public-links
    - /docs/v0.46/embedding/12-public-links
    - /docs/v0.46/questions/sharing/public-links
---
...
For more information about the option to **Embed this item in an application**, see the docs on [signed embedding](../../embedding/signed-embedding).
...
Metabase's automatic [drill-through](/learn/questions/drill-through) won't work on public dashboards because public links don't give people access to your raw data.

You can simulate drill-through on a public dashboard by setting up a [custom click behaviour](../../dashboards/interactive) that sends people from one public link to another public link.
...
If you'd like to create a secure embed that prevents people from changing filter names or values, check out [signed embedding](../../embedding/signed-embedding).
...
² Available on [paid plans](/pricing) and hides the download button on questions only (not dashboards).
...
You can display a filtered view of your question or dashboard in a public embed. Make sure you've set up a [question filter](../query-builder/introduction#filtering) or [dashboard filter](../../dashboards/filters) first.
