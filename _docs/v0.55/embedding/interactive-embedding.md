...
layout: new-docs
redirect_from:
    - /docs/v0.55/enterprise-guide/full-app-embedding
    - /docs/v0.55/embedding/full-app-embedding
---
...
Check out the [Interactive embedding quick start](/docs/v0.55/embedding/interactive-embedding-quick-start-guide).
...
- [Node.js + Express](https://github.com/metabase/metabase-nodejs-express-interactive-embedding-sample) (with [quick start guide](/docs/v0.55/embedding/interactive-embedding-quick-start-guide))
- [Node.js + React](https://github.com/metabase/sso-examples/tree/master/app-embed-example)

## Further reading

- [Interactive embedding quick start](/docs/v0.55/embedding/interactive-embedding-quick-start-guide)
