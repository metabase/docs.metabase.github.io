...
layout: new-docs
redirect_from:
    - /docs/v0.55/operations-guide/migrating-from-h2
    - /docs/v0.55/operations-guide/running-migrations-manually
---
...
You could also choose to run Metabase on a [Metabase Cloud](/pricing/) plan, which takes care of all of this stuff for you. If you have an existing Metabase, here's how you can [migrate to Metabase Cloud](/docs/latest/cloud/migrate/guide).
