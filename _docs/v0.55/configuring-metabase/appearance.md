...
layout: new-docs
redirect_from:
    - /docs/v0.55/administration-guide/whitelabeling
    - /docs/v0.55/enterprise-guide/whitelabeling
    - /docs/v0.55/enterprise-guide/customize-embeds
    - /docs/v0.55/embedding/whitelabeling
    - /docs/v0.55/embedding/fonts
    - /docs/v0.55/embedding/customize-embeds
---
