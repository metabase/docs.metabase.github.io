...
With these offsets (the Sums in the "Previous period" column), we can then create [custom columns](../editor#custom-columns) to calculate things like the difference between yearly Sums:
