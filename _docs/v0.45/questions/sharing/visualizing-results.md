...
layout: new-docs
redirect_from:
    - /docs/v0.45/users-guide/05-visualizing-results
---
...
Once a question returns results, you can save the question, download the results, or add the question to a [dashboard](../../dashboards/start).
...
The **Table** option is good for looking at tabular data (duh), or for lists of things like users or orders. The visualization options for tables allow you to add, hide, or rearrange fields in the table you're looking at, as well as modify their formatting. Check out [Everything you can do with the table visualization](/learn/basics/visualizing-data/table).
...
> Changing these options doesn't change the actual table itself; these changes create a custom view of the table that you can save as a **question** in Metabase and refer to later, share with others, or add to a [dashboard](../../dashboards/start).
...
For more, check out [How to create a pivot table to summarize your data](/learn/basics/visualizing-data/how-to-create-pivot-tables).

### Line, bar, and area charts

**Line charts** are best for displaying the trend of a number over time, especially when you have lots of x-axis values. For more, check out our [Guide to line charts](/learn/basics/visualizing-data/line-charts).
...
- **Add a goal line**. Goal lines can be used in conjunction with [alerts](./alerts) to send an email or a Slack message when your metric cross this line.
