...
layout: new-docs
redirect_from:
    - /docs/v0.45/administration-guide/12-public-links
    - /docs/v0.45/embedding/12-public-links
    - /docs/v0.45/questions/sharing/public-links
---
...
If you want to create a drill-down pathway on your question or dashboard, you can set up a [custom destination](../../dashboards/interactive) that goes to the public link of another question or dashboard.
