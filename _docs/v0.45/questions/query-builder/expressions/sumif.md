...
You can combine the `Sum` and [`case`](./case) formulas
...
The SQL `GROUP BY` statement maps to a Metabase [**Group by**](../../query-builder/introduction#summarizing-and-grouping-by) column set to "Date Received: Month".
