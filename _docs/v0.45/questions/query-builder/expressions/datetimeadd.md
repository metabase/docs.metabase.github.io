...
category: Questions
title: DatetimeAdd
source_url: 'https://github.com/metabase/metabase/blob/master/docs/questions/query-builder/expressions/datetimeadd.md'
layout: new-docs
---
...
To check if a specific datetime falls between your start and end datetimes, use [`between`](../expressions-list#between).
...
4. Create a [left join](../../query-builder/join) between **Coffee** and the "Today" model on `[Opened On] <= [Today]` and `[Finish By] >= [Today]`.
...
| [Data type](/learn/databases/data-types-overview#examples-of-data-types) | Works with `datetimeAdd` |
| ------------------------------------------------------------------------------------------------ | ------------------------ |
| String                                                                                           | ❌                       |
| Number                                                                                           | ❌                       |
| Timestamp                                                                                        | ✅                       |
