...
layout: new-docs
redirect_from:
    - /docs/v0.45/users-guide/13-sql-parameters
---
...
If you want to change the filter widget for a particular field, you'll need to ask an Admin to update that field in [the data model](../../data-modeling/metadata-editing) and set the desired "Filtering on this field" option.
