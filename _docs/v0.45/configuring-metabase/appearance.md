...
layout: new-docs
redirect_from:
    - /docs/v0.45/administration-guide/whitelabeling
    - /docs/v0.45/enterprise-guide/whitelabeling
    - /docs/v0.45/enterprise-guide/customize-embeds
    - /docs/v0.45/embedding/whitelabeling
    - /docs/v0.45/embedding/fonts
    - /docs/v0.45/embedding/customize-embeds
---
