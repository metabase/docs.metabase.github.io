...
layout: new-docs
redirect_from:
    - /docs/v0.45/operations-guide/running-metabase-on-heroku
---

# Running Metabase on Heroku


> Note: Metabase will be deprecating Heroku in an upcoming release. To migrate off Heroku, see our guide on [Migrating from Heroku to Metabase Cloud](/cloud/docs/migrate/heroku).
