...
layout: new-docs
redirect_from:
    - /docs/v0.45/operations-guide/upgrading-metabase
---
...
- [AWS Elastic Beanstalk deployments](./running-metabase-on-elastic-beanstalk#deploying-new-versions-of-metabase-on-elastic-beanstalk)
- [Azure Web Apps deployments](./running-metabase-on-azure#additional-configurations)
- [Heroku deployments](./running-metabase-on-heroku#deploying-new-versions-of-metabase)
