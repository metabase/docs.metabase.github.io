...
layout: new-docs
redirect_from:
    - /docs/v0.45/users-guide/field-types
---
...
If you're an administrator, you can edit field types using the [Data Model page](./metadata-editing) in the Admin Panel.
...
- [The Data Model page: editing metadata](./metadata-editing).
