...
layout: new-docs
redirect_from:
    - /docs/v0.45/enterprise-guide/audit
---
...
For more, see [how permissions work with dashboard subscriptions and alerts](../dashboards/subscriptions#how-permissions-work-with-dashboard-subscriptions).
