...
layout: new-docs
redirect_from:
    - /docs/v0.45/users-guide/12-data-model-reference
    - /docs/v0.45/questions/native-editor/data-model-reference
---
...
If a foreign key relationship exists in your database, but doesn't show up in your Metabase, your Metabase admin will need to update your [Metabase data model](../data-modeling/metadata-editing).
