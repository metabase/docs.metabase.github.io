...
layout: new-docs
redirect_from:
    - /docs/v0.45/users-guide/03-basic-exploration
---
...
If you click on a part of a chart, such as a bar in a bar chart, or a dot on a line chart, you'll see a the **Action menu**, with actions you can take to dive deeper into that result, branch off from it in a different direction, or create an [X-ray](x-rays) to see an automatic exploration of the data.
