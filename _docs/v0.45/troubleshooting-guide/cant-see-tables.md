...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/troubleshooting-guide/cant-see-tables.md'
layout: new-docs
---
...
- you don't see the tables in the [Data Model](../data-modeling/metadata-editing) section of the Admin Panel,
- the tables don't appear in the [Data Browser](/learn/getting-started/data-browser),
...
If you can't connect to the database with another application, the problem is probably not with Metabase. Please check that the database server is running and that you have the correct host, port, username, password, and other settings. For more help, see [Troubleshooting database connections](./db-connection).
...
If the administrator's account can see the tables but an individual person cannot, see [Troubleshooting data permissions](./data-permissions).
