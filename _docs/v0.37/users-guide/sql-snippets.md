...
**SQL snippets** are reusable bits of SQL or native queries. Anyone with permissions to the [SQL editor](writing-sql.html) can create and edit snippets, which are then available for all SQL authors.
