...
title: '09 Single Sign On'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/administration-guide/09-single-sign-on.md'
layout: docs
---
...
Learn how to easily [make a Getting Started Guide](10-getting-started-guide.html) for your team.
