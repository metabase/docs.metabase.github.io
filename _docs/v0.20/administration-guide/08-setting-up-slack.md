...
title: '08 Setting Up Slack'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/administration-guide/08-setting-up-slack.md'
layout: docs
---
...
## Next: Single Sign-On
Learn how to [configure Single Sign-On](08-single-sign-on.html) to let users sign in or sign up with just a click.
