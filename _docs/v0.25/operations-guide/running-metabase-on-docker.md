...
If you're trying to upgrade your Metabase version on Docker, check out these [upgrading instructions](https://metabase.com/docs/v0.25/operations-guide/start#upgrading-metabase).
...
For general information, see instructions for [migrating from H2 to MySQL or Postgres](https://metabase.com/docs/v0.25/operations-guide/start#migrating-from-using-the-h2-database-to-mysql-or-postgres).
...
While running Metabase on docker you can use any of the custom settings from [Customizing the Metabase Jetty Webserver](https://metabase.com/docs/v0.25/operations-guide/start#customizing-the-metabase-jetty-webserver) by setting environment variables on your docker run command.
...
to [these instructions](https://metabase.com/docs/v0.25/operations-guide/start#metabase-fails-to-start-due-to-heap-space-outofmemoryerrors) for details on how to do that.
