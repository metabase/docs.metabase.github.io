...
If you’re using Heroku, here are [instructions on how to get this information](https://metabase.com/docs/v0.24/administration-guide/01-managing-databases#heroku-databases). If you’re an Amazon RDS kind of person, you can follow [these instruction).
