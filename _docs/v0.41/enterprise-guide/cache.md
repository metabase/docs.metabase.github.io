...
title: Cache
source_url: 'https://github.com/metabase/metabase/blob/master/docs/enterprise-guide/cache.md'
---
...
[caching]: ../users-guide/06-sharing-answers#caching-results
[caching-admin]: ../administration-guide/14-caching
