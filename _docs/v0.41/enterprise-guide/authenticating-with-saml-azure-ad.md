...
title: 'Authenticating With SAML Azure Ad'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/enterprise-guide/authenticating-with-saml-azure-ad.md'
---
...
To enable SAML authentication and use Azure AD as an identity provider, you need to have [Metabase Enterprise Edition](/enterprise/index).
