...
title: '08 Data Model Reference'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/users-guide/08-data-model-reference.md'
layout: docs
---
...
Next we'll take a look at how to combine what we've learned so far and [visualize multiple series on a chart](09-multi-series-charting.html).
