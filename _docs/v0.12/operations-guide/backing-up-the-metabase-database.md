...
title: 'Backing Up the Metabase Database'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/operations-guide/backing-up-the-metabase-database.md'
layout: docs
---
