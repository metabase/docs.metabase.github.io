...
title: '06 Dashboard Tips'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/users-guide/06-dashboard-tips.md'
layout: docs
---
...
Sometimes you’ll need help understanding what data is available to you and what it means. Metabase provides a way for your administrators and data experts to build a [data model reference](07-data-model-reference.html) to help you make sense of your database.