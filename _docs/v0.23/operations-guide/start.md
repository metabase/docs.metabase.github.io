...
#### [Upgrading AWS Elastic Beanstalk deployments](https://metabase.com/docs/v0.23/operations-guide/running-metabase-on-elastic-beanstalk#deploying-new-versions-of-metabase)
Step-by-step instructions on how to upgrade Metabase running on Elastic Beanstalk using RDS.

#### [Upgrading Heroku deployments](https://metabase.com/docs/v0.23/operations-guide/running-metabase-on-heroku#deploying-new-versions-of-metabase)
