...
layout: new-docs
redirect_from:
    - /docs/v0.58/questions/query-builder/introduction
    - /docs/v0.58/questions/query-builder
---
...
The data section is where you select the data you want to work with. Here you'll pick a [model](../../data-modeling/models), a [metric](../../data-modeling/metrics), a table from a database, or a saved question. You can search by typing, or browse your databases and collections.
