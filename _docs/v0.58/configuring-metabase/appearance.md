...
layout: new-docs
redirect_from:
    - /docs/v0.58/administration-guide/whitelabeling
    - /docs/v0.58/enterprise-guide/whitelabeling
    - /docs/v0.58/enterprise-guide/customize-embeds
    - /docs/v0.58/embedding/whitelabeling
    - /docs/v0.58/embedding/fonts
    - /docs/v0.58/embedding/customize-embeds
---
