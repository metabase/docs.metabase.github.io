...
If you want people outside of your Metabase to use an action, you can create a [public form for an action](../actions/custom#make-public), or expose actions via [Full app embedding](../embedding/full-app-embedding).
