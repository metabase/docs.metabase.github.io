...
title: '11 Data Model Reference'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/users-guide/11-data-model-reference.md'
layout: docs
---
...
Find out [how to use variables in your native SQL queries](12-sql-parameters.html) to create powerful filter widgets and more.
