...
[Administrators can give you different kinds of access](../administration-guide/06-collections) to each collection:
...
If you just want to organize _your_ favorite items, you should [bookmark them](03-basic-exploration#bookmarks) (only you can see your bookmarks).
