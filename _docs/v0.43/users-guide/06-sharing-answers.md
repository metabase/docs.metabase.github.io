...
- **Turn this into a model**. See [Models](models.html).
...
- **Bookmark** Save the question as a favorite, which will show up in the bookmarks section of your navigation sidebar. See [Bookmarks](03-basic-exploration.html#bookmarks).
...
[alerts]: 15-alerts.html
[archiving-items]: collections.html#archiving-items
[caching]: ../administration-guide/14-caching.html
