...
- **Turn this into a model**. See [Models](models).
...
- **Bookmark** Save the question as a favorite, which will show up in the bookmarks section of your navigation sidebar. See [Bookmarks](03-basic-exploration#bookmarks).
...
[alerts]: 15-alerts
[archiving-items]: collections#archiving-items
[caching]: ../administration-guide/14-caching
