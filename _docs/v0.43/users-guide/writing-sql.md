...
Select **+ New** in the main nav bar. If you have the [permissions](../administration-guide/05-setting-permissions.html) to use the SQL editor, you'll see an option to start a new **SQL query** next to a little console icon.
...
[ref-models]: ./referencing-saved-questions-in-queries.html
