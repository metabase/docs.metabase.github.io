...
Select **+ New** in the main nav bar. If you have the [permissions](../administration-guide/05-setting-permissions) to use the SQL editor, you'll see an option to start a new **SQL query** next to a little console icon.
...
For an example, see the documentation on [Referencing models and saved questions in SQL queries](../users-guide/referencing-saved-questions-in-queries).
...
[asking-questions]: ../users-guide/04-asking-questions#creating-a-new-question-with-the-query-builder
