...
Once a question returns results, you can save the question, download the results, or add the question to a [dashboard](07-dashboards).
...
Not sure which visualization type to use? Check out [Which chart should you use?](/learn/basics/visualizing-data/guide).
...
> Changing these options doesn't change the actual table itself; these changes create a custom view of the table that you can save as a **question** in Metabase and refer to later, share with others, or add to a [dashboard](07-dashboards).
...
Now let's learn about [saving, editing, and sharing your questions](06-sharing-answers).
