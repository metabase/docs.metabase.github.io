...
If you'd like to have people authenticate with [SAML][saml-docs] or [JWT][jwt-docs], Metabase's [paid plans](/pricing) let you do just that.
...
Manually assigning people to [groups](04-managing-users#groups) in Metabase after they've logged in via SSO can get tedious. Instead, you can take advantage of the groups that already exist in your LDAP directory by enabling [group mappings](/learn/permissions/ldap-auth-access-control#group-management).
...
- [Using LDAP for authentication and access control](/learn/permissions/ldap-auth-access-control)
- [LDAP troubleshooting guide](../troubleshooting-guide/ldap)
...
For common issues, go to [Troubleshooting logins](../troubleshooting-guide/cant-log-in).

[data-sandboxing-docs]: ../enterprise-guide/data-sandboxes
[google-saml-docs]: ../enterprise-guide/saml-google
[jwt-docs]: ../enterprise-guide/authenticating-with-jwt
[saml-docs]: ../enterprise-guide/authenticating-with-saml
[sso-docs]: ../administration-guide/sso
[user-attributes-docs]: ../enterprise-guide/data-sandboxes#getting-user-attributes
