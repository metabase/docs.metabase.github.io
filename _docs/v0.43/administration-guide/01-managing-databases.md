...
- [Partner](../developers-guide-drivers)
- [Community](../developers-guide-drivers)

### Officially supported databases

The following databases have official drivers maintained by the Metabase team. Customers on [paid plans](/pricing/) will get official support. 

- [BigQuery](databases/bigquery) (Google Cloud Platform)
- Druid
- [Google Analytics](databases/google-analytics)
- H2
- [MongoDB (version 3.6 or higher)](databases/mongodb) <!-- MongoDB supported version is from https://www.mongodb.com/support-policy -->
...
- [AWS's Relational Database Service (RDS)](databases/aws-rds)
...
See our [guide to SSH tunneling](ssh-tunnel-for-database-connections).
...
For more on editing metadata, check out [the Data Model page: editing metadata](03-metadata-editing).
...
If you're having trouble with your database connection, you can check out this [troubleshooting guide](/docs/latest/troubleshooting-guide/datawarehouse), or visit [Metabase's discussion forum](https://discourse.metabase.com/) to see if someone has encountered and resolved a similar issue.
