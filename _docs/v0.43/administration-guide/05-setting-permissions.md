...
- Permissions are granted to [groups](04-managing-users#groups), not people.
...
[Application permissions](application-permissions) (available on paid plans) dictate access to Metabase application-level features, including:
...
- [Managing people and groups](04-managing-users)
