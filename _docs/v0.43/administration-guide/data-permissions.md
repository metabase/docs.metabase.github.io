...
- If the question was created using the [graphical query builder](../users-guide/04-asking-questions.html), the person would also need to be in a group with **Unrestricted data access** or **Sandboxed access** to the relevant database (or table) to view that question.
- If the question was created using the [native/SQL editor](../users-guide/writing-sql.html), the person would need to be a member of a group with both **Unrestricted data access** and **Native query editing** set to **YES** to view that question.
...
Groups with unrestricted access can use the [graphical query builder](../users-guide/04-asking-questions.html) to ask questions about this table.
...
You can define whether a group can [edit metadata](03-metadata-editing.html). Options are:
...
[collections]: 06-collections.html
[dashboard-subscriptions]: ../users-guide/dashboard-subscriptions.html
[data-sandboxing]: ../enterprise-guide/data-sandboxes.html
[permissions-overview]: 05-setting-permissions.html
