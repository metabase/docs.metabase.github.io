...
If you want to run Metabase in production, you'll need store your application data in a [production-ready database](./migrating-from-h2.html#supported-databases-for-storing-your-metabase-application-data).
...
If you've already been running Metabase with the default application database (H2), and want to use a production-ready application database without losing your app data (your questions, dashboards, etc), see [Migrating from H2 to a production database](migrating-from-h2.html).
...
You can use any of the custom settings from [Customizing the Metabase Jetty Webserver](customizing-jetty-webserver.html) by setting environment variables in your Docker run command.
...
See Running Metabase in the [Troubleshooting guide](../troubleshooting-guide/running.html).
