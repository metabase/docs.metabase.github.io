...
You can use any of the custom settings from [Customizing the Metabase Jetty Webserver](customizing-jetty-webserver) by setting environment variables in your Docker run command.
...
We currently support the following [environment variables](environment-variables) to be used as secrets:
