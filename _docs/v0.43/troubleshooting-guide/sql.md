...
- [SQL query contains a subquery (nested query) or CTE](../users-guide/13-sql-parameters#field-filters-dont-work-with-table-aliases).
- [400 error from BigQuery](../users-guide/13-sql-parameters#some-databases-require-the-schema-in-the-from-clause).
- [SQL syntax error: missing `FROM` clause](../users-guide/writing-sql#how-metabase-executes-sql-variables).

### Text, number, or date variables

- [No option to display a filter widget](../users-guide/13-sql-parameters#field-filter-compatible-types).
