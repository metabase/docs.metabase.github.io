...
1. [Check if your database connection is successful](../administration-guide/01-managing-databases#testing-the-connection-status).
2. If your connection isn't working, go to [Troubleshooting database connections](./datawarehouse). 
