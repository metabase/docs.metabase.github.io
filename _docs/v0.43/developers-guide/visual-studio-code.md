...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/developers-guide/visual-studio-code.md'
layout: docs
---
...
See [here](dev-branch-docker.html) for more on running development branches of Metabase using Docker.
