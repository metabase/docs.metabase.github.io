...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/enterprise-guide/saml-auth0.md'
---
...
2. [Configure SAML in Metabase](../enterprise-guide/authenticating-with-saml#enabling-saml-authentication-in-metabase) (the service provider).

For more information, check out our guide for [authenticating with SAML](../enterprise-guide/authenticating-with-saml).
...
For common issues, see our [SAML troubleshooting page](../troubleshooting-guide/saml).
