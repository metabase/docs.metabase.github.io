...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/enterprise-guide/dashboard-subscriptions.md'
layout: docs
---
...
You can customize which filter values to apply to each [dashboard subscriptions](../users-guide/dashboard-subscriptions.html). That way you can send different groups of people an email (or Slack message) the contents of the dashboard with different filters applied. You only need to maintain one dashboard, which you can use to send results relevant to each subscriber.
