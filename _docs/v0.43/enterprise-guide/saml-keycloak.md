...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/enterprise-guide/saml-keycloak.md'
---
...
2. [Set up SAML in Metabase](../enterprise-guide/authenticating-with-saml#enabling-saml-authentication-in-metabase) (the service provider).
