...
title: Mysql
source_url: 'https://github.com/metabase/metabase/blob/master/docs/administration-guide/databases/mysql.md'
---
...
If you're still experiencing problems connecting, please refer to the [troubleshooting guide](../../troubleshooting-guide/datawarehouse#mysql-unable-to-log-in-with-correct-credentials).
