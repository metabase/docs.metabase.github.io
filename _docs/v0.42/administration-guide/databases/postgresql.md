...
title: Postgresql
source_url: 'https://github.com/metabase/metabase/blob/master/docs/administration-guide/databases/postgresql.md'
---
...
[ssh-tunnel]: ../ssh-tunnel-for-database-connections
