...
title: Plugins
source_url: 'https://github.com/metabase/metabase/blob/master/docs/developers-guide/drivers/plugins.md'
layout: docs
---
...
[Implementing multimethods](multimethods.html) for your driver.
