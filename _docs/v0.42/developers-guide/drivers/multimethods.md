...
title: Multimethods
source_url: 'https://github.com/metabase/metabase/blob/master/docs/developers-guide/drivers/multimethods.md'
---
...
You can define a driver parent by listing the parent in the [plugin manifest](plugins).
