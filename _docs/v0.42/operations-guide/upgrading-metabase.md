...
See [Backing up Metabase application data](backing-up-metabase-application-data.html).
...
1. [Back up your application database](backing-up-metabase-application-data.html).
