...
title: Serialization
source_url: 'https://github.com/metabase/metabase/blob/master/docs/enterprise-guide/serialization.md'
---
...
If you're looking to do a one-time migration from H2 to MySQL/Postgres, then use the [migration guide instead](../operations-guide/migrating-from-h2).
...
To learn more, check out [Serialization: preloading dashboards in a new Metabase instance](/blog/serialization/index).
