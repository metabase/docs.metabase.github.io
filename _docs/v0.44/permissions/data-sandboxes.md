...
layout: new-docs
redirect_from:
    - /docs/v0.44/enterprise-guide/data-sandboxes
---
...
Data sandboxes are a powerful and flexible permissions tool that allow you to grant filtered access to specific tables. If you haven't already, check out our [overview of how permissions work in Metabase](../permissions/introduction).
...
1. If you've already [connected your SSO](../people-and-groups/authenticating-with-saml) to Metabase, any user attributes you set there can be automatically passed to Metabase.
