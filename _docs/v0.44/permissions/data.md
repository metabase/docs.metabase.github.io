...
layout: new-docs
redirect_from:
    - /docs/v0.44/administration-guide/data-permissions
---
...
Members of a group with Native query editing set to Yes can write new SQL/native queries using the [native query editor](../questions/native-editor/writing-sql). This access level requires the group to additionally have Unrestricted data access for the database in question, since SQL queries can circumvent table-level permissions.
...
You can define whether a group can [edit metadata](../data-modeling/metadata-editing). Options are:
...
- Edit any of the [connection options](../databases/connecting#database-connection-options) for the data source,
- [sync schemas](../databases/connecting#manually-syncing-tables-and-columns), and
- [scan field values](../databases/connecting#manually-scanning-column-values).
