...
layout: new-docs
redirect_from:
    - /docs/v0.44/enterprise-guide/serialization
---
...
If you're looking to do a one-time migration from H2 to MySQL/Postgres, then use the [migration guide instead](./migrating-from-h2).
...
To learn more, check out [Serialization: preloading dashboards in a new Metabase instance](/learn/administration/serialization).
