...
title: Timezones
source_url: 'https://github.com/metabase/metabase/blob/master/docs/configuring-metabase/timezones.md'
layout: new-docs
redirect_from:
    - /docs/v0.44/operations-guide/handling-timezones
---
...
- `Metabase Cloud` - if you need to change the timezone on the server that hosts your Metabase Cloud instance, please [contact support](/help-premium).
