...
layout: new-docs
redirect_from:
    - /v0.44/administration-guide/whitelabeling
    - /v0.44/enterprise-guide/whitelabeling
    - /v0.44/enterprise-guide/customize-embeds
    - /v0.44/embedding/whitelabeling
    - /v0.44/embedding/fonts
    - /v0.44/embedding/customize-embeds
---
