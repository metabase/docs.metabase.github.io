...
layout: new-docs
redirect_from:
    - /docs/v0.44/administration-guide/whitelabeling
    - /docs/v0.44/enterprise-guide/whitelabeling
    - /docs/v0.44/enterprise-guide/customize-embeds
    - /docs/v0.44/embedding/whitelabeling
    - /docs/v0.44/embedding/fonts
    - /docs/v0.44/embedding/customize-embeds
---
