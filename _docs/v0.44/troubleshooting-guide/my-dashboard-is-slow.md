...
One of the easiest ways to make a question or dashboard run faster is to work with a smaller dataset. Your Metabase admin can apply automatic data limitations using things like [SSO](../people-and-groups/start#setting-up-single-sign-on-sso), [data permissions](../permissions/data), and [data sandboxing](../permissions/data-sandboxes).
