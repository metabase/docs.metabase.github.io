...
layout: new-docs
permalink: /docs/v0.44/index.html
redirect_from:
    - /docs/v0.44/enterprise-guide
    - /docs/v0.44/users-guide
    - /docs/v0.44/administration-guide
    - /docs/v0.44/operations-guide
---
...
- [Data reference](./questions/native-editor/data-model-reference)
...
- [Setting and getting alerts](./questions/sharing/alerts)
- [Public links](./questions/sharing/public-links)
...
- [Metabase logs](./configuring-metabase/log-configuration)
...
### [Paid features](./paid-features/start)
