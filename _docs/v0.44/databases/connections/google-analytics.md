...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/databases/connections/google-analytics.md'
layout: new-docs
redirect_from:
    - /docs/v0.44/administration-guide/databases/google-analytics
---
...
[sync-docs]: ../connecting#syncing-and-scanning-databases
