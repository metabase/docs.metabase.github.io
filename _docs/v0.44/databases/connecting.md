...
layout: new-docs
redirect_from:
    - /docs/v0.44/administration-guide/01-managing-databases
---
...
- H2
- [MongoDB (version 3.6 or higher)](./connections/mongodb) <!-- MongoDB supported version is from https://www.mongodb.com/support-policy -->
