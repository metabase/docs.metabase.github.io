...
category: Questions
title: Case
source_url: 'https://github.com/metabase/metabase/blob/master/docs/questions/query-builder/expressions/case.md'
layout: new-docs
---
...
For example, this [SQL trick to order bar charts](/learn/sql-questions/sql-tricks-ordering-charts) could be written using a Metabase `case` expression instead.
...
[data-sandboxing-docs]: ../../../permissions/data-sandboxes#filtering-a-sandboxed-table
...
[sql-reference-guide]: /learn/debugging-sql/sql-syntax#common-sql-reference-guides
