...
layout: new-docs
redirect_from:
    - /docs/v0.44/users-guide/sql-snippets
---
...
Some plans contain additional functionality for organizing snippets into folders and setting permissions on those folders. See our [docs on SQL snippet folders and permissions](./sql-snippets).
