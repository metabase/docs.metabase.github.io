...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/questions/native-editor/data-model-reference.md'
layout: new-docs
redirect_from:
    - /docs/v0.44/users-guide/12-data-model-reference
---
