...
layout: new-docs
redirect_from:
    - /docs/v0.44/administration-guide/04-managing-users
---
...
If you’ve already [configured Metabase to use email](../configuring-metabase/email), Metabase will send the new user an invite email. Otherwise, it’ll give you a temporary password that you’ll have to send to the person you’re inviting by hand.
...
- [Configure Single Sign-On](./start).
