...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/operations-guide/handling-timezones.md'
---
...
If you are still experiencing timezone problems, then have a look at the [timezone troubleshooting guide](../troubleshooting-guide/times-appear-incorrect).
