...
title: 'Times Appear Incorrect'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/troubleshooting-guide/times-appear-incorrect.md'
---
...
[data-model]: ../users-guide/12-data-model-reference
