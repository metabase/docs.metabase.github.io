...
[configuring-application-database]: ../operations-guide/configuring-application-database
[persistent-volume]: ../operations-guide/running-metabase-on-docker#mounting-a-mapped-file-storage-volume
