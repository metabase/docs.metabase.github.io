...
title: Sandboxing
source_url: 'https://github.com/metabase/metabase/blob/master/docs/troubleshooting-guide/sandboxing.md'
---
...
[authenticating-with-saml]: ../enterprise-guide/authenticating-with-saml
[locked-parameters]: /learn/embedding/embedding-charts-and-dashboards#hide-or-lock-parameters-to-restrict-what-data-is-shown
...
[groups]: ../administration-guide/05-setting-permissions#group
[jwt-auth]: ../enterprise-guide/authenticating-with-jwt
[one-sandbox-per-table]: ../enterprise-guide/data-sandboxes#a-user-can-only-have-one-sandbox-per-table
[permissions]: /learn/permissions/data-permissions
[prepared-statement]: /glossary#prepared_statement
[public-sharing]: ../administration-guide/12-public-links
[row-permissions]: /learn/permissions/data-sandboxing-row-permissions
[sandboxing-your-data]: ../enterprise-guide/data-sandboxes
[signed-embedding]: /learn/embedding/embedding-charts-and-dashboards#enable-embedding-in-other-applications
[cant-see-tables]: cant-see-tables
[sandbox-limitations]: ../enterprise-guide/data-sandboxes#current-limitations
[unsupported-databases]: ../enterprise-guide/data-sandboxes#data-sandboxes-do-not-support-non-sql-databases
