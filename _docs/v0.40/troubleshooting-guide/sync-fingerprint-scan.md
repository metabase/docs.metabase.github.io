...
[bugs]: ./bugs
[community-db-drivers]: ../developers-guide-drivers
[etl]: /glossary#etl
[metabase-api]: ../api-documentation
[metabase-mongo-missing]: ../administration-guide/databases/mongodb#i-added-fields-to-my-database-but-dont-see-them-in-metabase
[sync-frequency]: ../administration-guide/01-managing-databases#choose-when-metabase-syncs-and-scans
[troubleshooting-db-connection]: ./datawarehouse
