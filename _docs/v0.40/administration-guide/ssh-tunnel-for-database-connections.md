...
title: 'Ssh Tunnel for Database Connections'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/administration-guide/ssh-tunnel-for-database-connections.md'
layout: docs
---
...
For more on connecting a database to Metabase, see [Adding and managing databases](01-managing-databases.html).
