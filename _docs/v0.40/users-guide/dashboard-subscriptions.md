...
Metabase Enterprise Edition allows you to [customize filter values for each subscription](../enterprise-guide/dashboard-subscriptions), so you can set up subscriptions with different filter values applied for different subscribers.
