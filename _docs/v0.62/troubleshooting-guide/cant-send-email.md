...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/troubleshooting-guide/cant-send-email.md'
layout: new-docs
---
...
3. Click **Send test email**. The test email will go to the address associated with your Metabase account.
