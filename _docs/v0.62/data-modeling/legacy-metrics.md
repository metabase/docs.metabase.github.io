...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/data-modeling/legacy-metrics.md'
layout: new-docs
---

# Legacy metrics

Metabase upgraded [metrics](./metrics) starting in version 51.
