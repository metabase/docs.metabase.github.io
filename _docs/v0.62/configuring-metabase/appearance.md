...
layout: new-docs
redirect_from:
    - /docs/v0.62/administration-guide/whitelabeling
    - /docs/v0.62/enterprise-guide/whitelabeling
    - /docs/v0.62/enterprise-guide/customize-embeds
    - /docs/v0.62/embedding/whitelabeling
    - /docs/v0.62/embedding/fonts
    - /docs/v0.62/embedding/customize-embeds
