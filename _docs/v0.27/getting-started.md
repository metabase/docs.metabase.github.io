...
source_url: 'https://github.com/metabase/metabase/blob/v0.27/docs/getting-started.md'
layout: docs
---
...
Want to learn more? Is your thirst for knowledge insatiable? Check out our [Users Guide](users-guide/start.html) for more in-depth explanations of the ins and outs of Metabase.
