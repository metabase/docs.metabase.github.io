...
title: Contributing
source_url: 'https://github.com/metabase/metabase/blob/v0.27/docs/contributing.md'
layout: docs
---
...
To get a sense for the end goals, make sure to read the [Zen of Metabase](../zen.html)
