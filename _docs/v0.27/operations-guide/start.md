...
title: Start
source_url: 'https://github.com/metabase/metabase/blob/v0.27/docs/operations-guide/start.md'
layout: docs
---
...
#### [Running the Jar File](running-the-metabase-jar-file.html)
...
#### [Running on AWS Elastic Beanstalk](running-metabase-on-elastic-beanstalk.html)
...
#### [Running on Heroku](running-metabase-on-heroku.html)
...
#### [Running on Cloud66](running-metabase-on-cloud66.html)
Community support only at this time, but we have reports of Metabase instances running on Cloud66!

#### [Running on Debian as a service](running-metabase-on-debian.html)
...
#### [Running on Kubernetes](running-metabase-on-kubernetes.html)
...
#### [Upgrading AWS Elastic Beanstalk deployments](https://metabase.com/docs/v0.27/operations-guide/running-metabase-on-elastic-beanstalk#deploying-new-versions-of-metabase)
Step-by-step instructions on how to upgrade Metabase running on Elastic Beanstalk using RDS.

#### [Upgrading Heroku deployments](https://metabase.com/docs/v0.27/operations-guide/running-metabase-on-heroku#deploying-new-versions-of-metabase)
...
Metabase's default logging configuration can be found [here](https://github.com/metabase/metabase/blob/v0.27/resources/log4j.properties). You can override this properties file and tell
