...
source_url: 'https://github.com/metabase/metabase/blob/v0.27/docs/operations-guide/running-metabase-on-elastic-beanstalk.md'
layout: docs
---
...
NOTE: If this screenshot does not match what you see in the Elastic Beanstalk console, it is likely that you are on an old version of the Elastic Beanstalk UI. At the time of writing this documentation, both versions of the UI are being reported in the wild. You can view our older documenatation [here](running-metabase-on-elastic-beanstalk-old.html)
