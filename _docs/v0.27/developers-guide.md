...
source_url: 'https://github.com/metabase/metabase/blob/v0.27/docs/developers-guide.md'
layout: docs
---
...
You can also skim through [`__support__/integrated_tests.js`](https://github.com/metabase/metabase/blob/v0.27/frontend/test/__support__/integrated_tests.js) and [`__support__/enzyme_utils.js`](https://github.com/metabase/metabase/blob/v0.27/frontend/test/__support__/enzyme_utils.js) to see all available methods.
