...
source_url: 'https://github.com/metabase/metabase/blob/v0.27/docs/administration-guide/10-single-sign-on.md'
layout: docs
---
...
Learn how to easily [make a Getting Started Guide](11-getting-started-guide.html) for your team.
