...
source_url: 'https://github.com/metabase/metabase/blob/v0.27/docs/users-guide/03-basic-exploration.md'
layout: docs
---
...
Click on the `Dashboards` nav item to see all the dashboards your teammates have created. Dashboards are simply collections of charts and numbers that you want to be able to refer back to regularly. (You can learn more about dashboards [here](07-dashboards.html))
