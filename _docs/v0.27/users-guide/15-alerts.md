...
title: '15 Alerts'
source_url: 'https://github.com/metabase/metabase/blob/v0.27/docs/users-guide/15-alerts.md'
layout: docs
---
...
### Getting alerts
To start using alerts, someone on your team who's an administrator will need to make sure that [email integration](../administrator-guide/02-setting-up-email.html) is set up first.
