...
layout: new-docs
redirect_from:
    - /docs/v0.49/users-guide/07-dashboards
---
...
- Questions, such as [tables, charts, or maps](../questions/sharing/visualizing-results)
...
See [Exporting results](../questions/sharing/exporting-results#exporting-results-of-a-dashboard).
