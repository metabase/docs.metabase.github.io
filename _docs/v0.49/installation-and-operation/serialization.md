...
layout: new-docs
redirect_from:
    - /docs/v0.49/enterprise-guide/serialization
---
...
- [Running multiple environments](/learn/administration/multi-env)
- [Setting up git-based workflow](/learn/administration/git-based-workflow)
...
- [Serialization tutorial](/learn/administration/serialization).
- [Multiple environments](/learn/administration/multi-env)
- [Setting up a git-based workflow](/learn/administration/git-based-workflow).
