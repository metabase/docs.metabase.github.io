...
layout: new-docs
redirect_from:
    - /docs/v0.49/administration-guide/12-public-links
    - /docs/v0.49/embedding/12-public-links
---
...
To embed a dashboard, see [static embedding](../../embedding/static-embedding).
...
See docs for the [export format endpoint](/docs/latest/api/public#get-apipubliccarduuidqueryexport-format).
