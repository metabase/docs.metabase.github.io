...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/questions/sharing/visualizations/line-bar-and-area-charts.md'
layout: new-docs
---
...
**Line charts** are best for displaying the trend of a number over time, especially when you have lots of x-axis values. For more, check out our [Guide to line charts](/learn/basics/visualizing-data/line-charts) and [Time series analysis](/learn/time-series) tutorials.
...
- [Guide to line charts](/learn/visualization/line-charts)
- [Master the bar chart](/learn/visualization/bar-charts)
- [Visualize your data as a histogram](/learn/visualization/histograms)
