...
layout: new-docs
redirect_from:
    - /docs/v0.49/administration-guide/09-setting-up-slack
---

# Slack

If you want to have your [dashboard subscriptions](../dashboards/subscriptions) or [alerts](../questions/sharing/alerts) sent to Slack channels (or people on Slack), an admin must first integrate your Metabase with Slack.
