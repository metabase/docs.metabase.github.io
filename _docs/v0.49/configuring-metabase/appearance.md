...
layout: new-docs
redirect_from:
    - /docs/v0.49/administration-guide/whitelabeling
    - /docs/v0.49/enterprise-guide/whitelabeling
    - /docs/v0.49/enterprise-guide/customize-embeds
    - /docs/v0.49/embedding/whitelabeling
    - /docs/v0.49/embedding/fonts
    - /docs/v0.49/embedding/customize-embeds
---
