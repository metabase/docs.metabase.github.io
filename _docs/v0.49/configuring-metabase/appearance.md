...
layout: new-docs
redirect_from:
    - /v0.49/administration-guide/whitelabeling
    - /v0.49/enterprise-guide/whitelabeling
    - /v0.49/enterprise-guide/customize-embeds
    - /v0.49/embedding/whitelabeling
    - /v0.49/embedding/fonts
    - /v0.49/embedding/customize-embeds
---
