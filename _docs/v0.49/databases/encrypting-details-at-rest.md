...
layout: new-docs
redirect_from:
    - /docs/v0.49/operations-guide/encrypting-database-details-at-rest
---
...
2. Set your secret key as the environment variable `MB_ENCRYPTION_SECRET_KEY`. On paid plans, you can set also set this using the [config file](../configuring-metabase/config-file).
