...
layout: new-docs
redirect_from:
    - /docs/v0.49/administration-guide/01-managing-databases
    - /docs/v0.49/databases/connections/sql-server
    - /docs/v0.49/administration-guide/databases/h2
    - /docs/v0.49/databases/connections/h2
---
...
- [MySQL (recommend version 8.0.33 or higher, as well as MariaDB version 10.4 or higher)](./connections/mysql)
