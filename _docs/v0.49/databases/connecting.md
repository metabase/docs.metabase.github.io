...
layout: new-docs
redirect_from:
    - /v0.49/administration-guide/01-managing-databases
    - /v0.49/databases/connections/sql-server
    - /v0.49/administration-guide/databases/h2
    - /v0.49/databases/connections/h2
---
