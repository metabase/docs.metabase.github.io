...
layout: new-docs
redirect_from:
    - /docs/v0.49/users-guide/events-and-timelines
---
...
> Archived events and timelines can only be viewed from the collection. They don't show up in the [main archive](../exploration-and-organization/history).
...
- [Keeping your Metabase organized](/learn/administration/same-page)
