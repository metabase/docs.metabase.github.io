...
layout: new-docs
redirect_from:
    - /docs/v0.49/users-guide/collections
---
...
Pairing Official badges with [verified items](./exploration#verified-items) can help everyone in your Metabase sort out which questions people can trust.
...
Pinned items will appear pinned for all people looking at the collection. If you just want to organize _your_ favorite items, you should [bookmark them](./exploration#bookmarks) (only you can see your bookmarks).
...
- [Multiple environments](/learn/administration/multi-env#one-collection-per-environment)
