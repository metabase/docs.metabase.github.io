...
layout: new-docs
redirect_from:
    - /docs/v0.49/enterprise-guide/authenticating-with-saml
---
...
The open source edition of Metabase includes the option to set up with [Google Sign-in or LDAP](./google-and-ldap), but [some plans](/pricing) let you connect your SAML- or [JWT](./authenticating-with-jwt)-based SSO. Integrating your SSO with Metabase allows you to:
