...
redirect_from:
    - /docs/docs-workflow-test-run/users-guide/sql-snippets
    - /docs/docs-workflow-test-run/questions/native-editor/sql-snippets
---
...
**Snippets** are reusable bits of SQL or native queries. Anyone with permissions to the [SQL editor](./writing-sql) can create and edit snippets, which are then available for all SQL authors.
