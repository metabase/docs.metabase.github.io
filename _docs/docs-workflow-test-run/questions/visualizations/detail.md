...
category: Questions
title: Detail
source_url: 'https://github.com/metabase/metabase/blob/master/docs/questions/visualizations/detail.md'
redirect_from:
    - /docs/docs-workflow-test-run/questions/sharing/visualizations/detail
---
