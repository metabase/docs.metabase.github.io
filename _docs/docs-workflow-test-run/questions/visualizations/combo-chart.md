...
category: Questions
title: 'Combo charts'
source_url: 'https://github.com/metabase/metabase/blob/master/docs/questions/visualizations/combo-chart.md'
redirect_from:
    - /docs/docs-workflow-test-run/questions/sharing/visualizations/combo-chart
---
