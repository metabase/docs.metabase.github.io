...
redirect_from:
    - /docs/docs-workflow-test-run/users-guide/04-asking-questions
    - /docs/docs-workflow-test-run/users-guide/06-sharing-answers
---
...
Questions saved to a collection can be added to multiple dashboards. Moving a question from one collection to another collection won't have any effect on the dashboards the question has been added to. In order to save a question to a collection, you'll need to be in a group with [curate access](../permissions/collections#curate-access) to that collection.
