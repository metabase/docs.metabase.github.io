...
redirect_from:
    - /docs/docs-workflow-test-run/administration-guide/whitelabeling
    - /docs/docs-workflow-test-run/enterprise-guide/whitelabeling
    - /docs/docs-workflow-test-run/enterprise-guide/customize-embeds
    - /docs/docs-workflow-test-run/embedding/whitelabeling
    - /docs/docs-workflow-test-run/embedding/fonts
    - /docs/docs-workflow-test-run/embedding/customize-embeds
---
