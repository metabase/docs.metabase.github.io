...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/people-and-groups/saml-azure.md'
redirect_from:
    - /docs/docs-workflow-test-run/enterprise-guide/authenticating-with-saml-azure-ad
---
