...
redirect_from:
    - /docs/docs-workflow-test-run/enterprise-guide/activating-the-enterprise-edition
    - /docs/docs-workflow-test-run/paid-features/activating-the-enterprise-edition
---
