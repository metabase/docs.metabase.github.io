...
redirect_from:
    - /docs/docs-workflow-test-run/operations-guide/running-metabase-on-azure
---
...
You'll need to add the [environment Variables](../configuring-metabase/environment-variables) for connecting Metabase to its [PostgreSQL Application Database](../installation-and-operation/configuring-application-database#postgresql). Make sure that you use the full **MB_DB_CONNECTION_URI**.
