...
redirect_from:
    - /docs/docs-workflow-test-run/operations-guide/running-metabase-on-elastic-beanstalk
    - /docs/docs-workflow-test-run/installation-and-operation/advanced-topics-for-running-Metabase-in-AWS-ElasticBeanstalk
    - /docs/docs-workflow-test-run/operations-guide/advanced-topics-for-running-Metabase-in-AWS-ElasticBeanstalk
---
...
If you'd like help with setting up Metabase (or building out your data stack in general), check out the [professional services we offer](/product/professional-services).
...
From this step on, you can follow the same steps as the [Configuring RDS for Metabase](./creating-RDS-database-on-AWS).
