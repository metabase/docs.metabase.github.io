...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/installation-and-operation/accessibility.md'
redirect_from:
    - /docs/docs-workflow-test-run/accessibility
    - /docs/docs-workflow-test-run/people-and-groups/accessibility
---
