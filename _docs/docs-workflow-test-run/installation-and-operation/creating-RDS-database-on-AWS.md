...
redirect_from:
    - /docs/docs-workflow-test-run/operations-guide/creating-RDS-database-on-AWS
---
...
After having finished all the previous steps, go to the your Metabase deployment and add the RDS instance as the Application Database with [Environment variables](../configuring-metabase/environment-variables).
