...
redirect_from:
    - /docs/docs-workflow-test-run/users-guide/12-data-model-reference
    - /docs/docs-workflow-test-run/questions/native-editor/data-model-reference
---
...
In the data reference sidebar, under **Connections**, you can find a list of table relationships (defined by [foreign keys](/glossary/foreign-key)).
