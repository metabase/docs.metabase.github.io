...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/exploration-and-organization/uploads.md'
---
...
If you [delete the uploaded table](../databases/uploads#deleting-tables-created-by-uploads), you won't be able to replace the model's data.
