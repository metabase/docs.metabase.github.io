...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/troubleshooting-guide/cant-view-or-edit.md'
---
...
4. Check the [Trash](../exploration-and-organization/delete-and-restore#see-items-in-trash).
...
3. If the steps above don't solve your problem, ask your Metabase admin if you have [permission to the database that's used by the question](../permissions/data#blocked-view-data-permission).
...
- [Error message: permission denied](./data-permissions#getting-a-permission-denied-error-message).
- [I can't view or edit queries from the SQL editor](./data-permissions#a-user-group-cant-access-the-sql-editor).
