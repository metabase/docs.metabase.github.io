...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/databases/connections/vertica.md'
redirect_from:
    - /docs/docs-workflow-test-run/administration-guide/databases/vertica
---
