...
redirect_from:
    - /docs/docs-workflow-test-run/administration-guide/01-managing-databases
    - /docs/docs-workflow-test-run/databases/connections/sql-server
    - /docs/docs-workflow-test-run/administration-guide/databases/h2
    - /docs/docs-workflow-test-run/databases/connections/h2
---
