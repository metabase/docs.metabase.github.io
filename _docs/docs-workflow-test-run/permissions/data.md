...
redirect_from:
    - /docs/docs-workflow-test-run/administration-guide/data-permissions
---
...
For _which_ questions, models, and dashboards a group can view, instead see [collection permissions](collections).
