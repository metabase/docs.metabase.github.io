...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/developers-guide/devenv.md'
layout: new-docs
---
...
To skip the setup wizard and pre-configure users, database connections, and settings, add a [Metabase config file](/docs/latest/configuring-metabase/config-file) to the directory where you run Metabase.
...
End-to-end tests simulate realistic sequences of user interactions. Read more about how we approach [end-to-end testing with Cypress](./e2e-tests).
