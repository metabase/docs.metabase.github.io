...
category: Embedding
title: MetabaseColors
source_url: 'https://github.com/metabase/metabase/blob/master/docs/embedding/sdk/api/snippets/MetabaseColors.md'
layout: new-docs
---
...
| <a id="background-error"></a> `background-error?`         | `string`                              | Color used for error backgrounds. Defaults to light red.                                |
...
| <a id="text-hover"></a> `text-hover?`                     | `string`                              | Color used for some button text on hover                                                |
...
| <a id="text-white"></a> `text-white?`                     | `string`                              | Color used for white text                                                               |
