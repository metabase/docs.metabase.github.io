...
layout: new-docs
redirect_from:
    - /docs/v0.61/administration-guide/whitelabeling
    - /docs/v0.61/enterprise-guide/whitelabeling
    - /docs/v0.61/enterprise-guide/customize-embeds
    - /docs/v0.61/embedding/whitelabeling
    - /docs/v0.61/embedding/fonts
    - /docs/v0.61/embedding/customize-embeds
