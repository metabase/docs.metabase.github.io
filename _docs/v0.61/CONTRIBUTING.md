...
layout: new-docs
redirect_from:
    - /docs/v0.61/developers-guide/contributing
---
...
All PRs that involve more than an insignificant change should be reviewed. See our [Code Review Process](/docs/latest/developers-guide/code-reviews).
