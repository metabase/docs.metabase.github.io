...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/troubleshooting-guide/data-permissions.md'
layout: new-docs
---
...
- [A user group with SQL permissions isn't being restricted by their row and column security policy](../permissions/row-and-column-security).
...
4. If you cannot access the table or schema in both step 1 and 3, ask your database admin to:
   - [Grant database privileges](../databases/users-roles-privileges) to the role that Metabase is using to connect, or
...
[admin-permissions]: ../permissions/introduction
[block-data-permission]: ../permissions/data#blocked-view-data-permission
[cant-see-tables]: ./cant-see-tables
[collection-permissions]: ../permissions/collections
[data-access]: ../permissions/data#data-permission-types
...
[unrestricted]: ../permissions/data#can-view-data-permission
