...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/people-and-groups/user-provisioning.md'
layout: new-docs
---
...
- [OIDC-based authentication](./authenticating-with-oidc)
