...
layout: new-docs
redirect_from:
    - /docs/v0.60/administration-guide/whitelabeling
    - /docs/v0.60/enterprise-guide/whitelabeling
    - /docs/v0.60/enterprise-guide/customize-embeds
    - /docs/v0.60/embedding/whitelabeling
    - /docs/v0.60/embedding/fonts
    - /docs/v0.60/embedding/customize-embeds
