...
To start building a question with the query builder, you need to select the data you want to work with. You can pick pick a a table from a database, a[model](../../data-modeling/models), a [metric](../../data-modeling/metrics), or another saved question. You can search by typing, or browse your databases and collections.
...
If you're using cumulative aggregation functions in you **Summarize** block, the sort order might affect how the aggregation is computed (as opposed to just how the results are displayed ). See [Cumulative functions](../query-builder/expressions/cumulative).
