...
layout: new-docs
redirect_from:
    - /docs/v0.48/enterprise-guide/full-app-embedding
    - /docs/v0.48/embedding/full-app-embedding
---
...
You can also set the the [`MB_SESSION_COOKIE_SAMESITE` environment variable](../configuring-metabase/environment-variables#mb_session_cookie_samesite).
