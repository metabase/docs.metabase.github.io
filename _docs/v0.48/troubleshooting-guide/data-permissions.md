...
[block-data-permission]: ../permissions/data#block-access
[cant-see-tables]: ./cant-see-tables
[collection-permissions]: ../permissions/collections
[data-access]: ../permissions/data#data-access
...
[native-query-editing]: ../permissions/data#native-query-editing
[no-self-service]: ../permissions/data#no-self-service-access
[pricing]: /pricing
[proxies]: ./proxies
...
[unrestricted]: ../permissions/data#unrestricted-access
