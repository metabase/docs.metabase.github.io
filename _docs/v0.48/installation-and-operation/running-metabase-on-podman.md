...
layout: new-docs
redirect_from:
    - /docs/v0.48/operations-guide/running-metabase-on-podman
---
...
Use this quick start if you have a [license token](../paid-features/activating-the-enterprise-edition) for a [paid version](/pricing) of Metabase, and you want to run Metabase locally.
