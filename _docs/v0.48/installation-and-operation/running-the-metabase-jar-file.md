...
layout: new-docs
redirect_from:
    - /docs/v0.48/operations-guide/running-the-metabase-jar-file
...
If you are using a paid version, be sure to [activate your license](../paid-features/activating-the-enterprise-edition).
...
If you are using a paid version of Metabase, be sure to [activate your license](../paid-features/activating-the-enterprise-edition).
