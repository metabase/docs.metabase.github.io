...
layout: new-docs
redirect_from:
    - /docs/v0.48/operations-guide/installing-metabase
---
...
For an overview on how to self-host Metabase, check out [how to run Metabase in production](/learn/administration/metabase-in-production).
