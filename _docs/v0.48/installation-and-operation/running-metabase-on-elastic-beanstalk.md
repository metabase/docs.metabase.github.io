...
layout: new-docs
redirect_from:
    - /docs/v0.48/operations-guide/running-metabase-on-elastic-beanstalk
    - /docs/v0.48/installation-and-operation/advanced-topics-for-running-Metabase-in-AWS-ElasticBeanstalk
    - /docs/v0.48/operations-guide/advanced-topics-for-running-Metabase-in-AWS-ElasticBeanstalk
---
