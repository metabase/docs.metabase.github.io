...
layout: new-docs
redirect_from:
    - /docs/v0.48/users-guide/field-types
---
...
When you [X-ray](../exploration-and-organization/x-rays) a table, model, or entity, Metabase considers both the data type and field type to display different charts that summarize that data.
