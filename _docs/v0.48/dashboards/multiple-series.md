...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/dashboards/multiple-series.md'
layout: new-docs
redirect_from:
    - /docs/v0.48/users-guide/09-multi-series-charting
---
