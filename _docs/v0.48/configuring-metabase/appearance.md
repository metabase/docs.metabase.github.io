...
layout: new-docs
redirect_from:
    - /v0.48/administration-guide/whitelabeling
    - /v0.48/enterprise-guide/whitelabeling
    - /v0.48/enterprise-guide/customize-embeds
    - /v0.48/embedding/whitelabeling
    - /v0.48/embedding/fonts
    - /v0.48/embedding/customize-embeds
---
