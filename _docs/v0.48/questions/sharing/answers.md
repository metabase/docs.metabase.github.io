...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/questions/sharing/answers.md'
layout: new-docs
redirect_from:
    - /docs/v0.48/users-guide/06-sharing-answers
---
...
A modal will appear, prompting you to give your question a name and description, and to pick which [collection](../../exploration-and-organization/collections) to save the question in. Note that your administrator might have set things up so that you're only allowed to [save questions in certain collection](../../permissions/collections), but you can always save items in your Personal Collection. After saving your question, you'll be asked if you want to add the question to a new or existing dashboard.
...
You can't download the image of a dashboard, but you can set up a [dashboard subscription](../../dashboards/subscriptions).
...
- [Verify](../../exploration-and-organization/exploration#verified-items) this question
- Add to [dashboard](../../dashboards/start)
- Move to another [collection](../../exploration-and-organization/collections)
- Turn into a [model](../../data-modeling/models)
- Duplicate
- [Archive](../../exploration-and-organization/history)

Click the **info** icon to:

- Add a description
- Edit the [cache duration](../../configuring-metabase/caching#caching-per-question)\*
- View [revision history](../../exploration-and-organization/history)

\* Available on [paid plans](/pricing).
...
- Open the **three dot** (...) menu > **Turn into a [model](../../data-modeling/models)**.
- [Create a new question](../query-builder/introduction#creating-a-new-question-with-the-query-builder) and search for your saved question under **Pick your starting data**.
- [Refer to the question in a SQL query](../native-editor/referencing-saved-questions-in-queries).

## Caching question results

{% include plans-blockquote.html feature="Caching question results" %}

See [Caching per question](../../configuring-metabase/caching#caching-per-question).

## Sharing questions with public links

If your Metabase administrator has enabled [public sharing](../../questions/sharing/public-links) on a saved question or dashboard, you can go to that question or dashboard and click on the sharing icon to find its public links. Public links can be viewed by anyone, even if they don't have access to Metabase. You can also use the public embedding code to embed your question or dashboard in a simple web page or blog post.
