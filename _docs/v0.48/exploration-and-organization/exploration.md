...
layout: new-docs
redirect_from:
    - /docs/v0.48/users-guide/03-basic-exploration
---
...
If you click on a part of a chart, such as a bar in a bar chart, or a dot on a line chart, you'll see a the **Action menu**, with actions you can take to dive deeper into that result, branch off from it in a different direction, or see automatic insights to [X-ray](x-rays) the data.
