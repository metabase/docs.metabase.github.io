...
layout: new-docs
redirect_from:
    - /docs/v0.48/administration-guide/05-setting-permissions
---
...
- [Databases connected to Metabase](./data)
...
[Application permissions](application) (available on paid plans) dictate access to Metabase application-level features, including:
