...
layout: new-docs
redirect_from:
    - /docs/v0.57/administration-guide/whitelabeling
    - /docs/v0.57/enterprise-guide/whitelabeling
    - /docs/v0.57/enterprise-guide/customize-embeds
    - /docs/v0.57/embedding/whitelabeling
    - /docs/v0.57/embedding/fonts
    - /docs/v0.57/embedding/customize-embeds
---
