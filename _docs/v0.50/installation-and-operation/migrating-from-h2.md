...
layout: new-docs
redirect_from:
    - /docs/v0.50/operations-guide/migrating-from-h2
    - /docs/v0.50/operations-guide/running-migrations-manually
---

# Migrating to a production application database

This page covers how to convert a Metabase that's been using the built-in application database, H2, to a production-ready instance PostgreSQL. For more on why you should use Postgres as your app DB, check out [How to run Metabase in production](/learn/administration/metabase-in-production).
