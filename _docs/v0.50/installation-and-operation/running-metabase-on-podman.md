...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/installation-and-operation/running-metabase-on-podman.md'
layout: new-docs
redirect_from:
    - /docs/v0.50/operations-guide/running-metabase-on-podman
---
...
Use this quick start if you have a [license token](../paid-features/activating-the-enterprise-edition) for a [Pro or Enterprise version](/pricing) of Metabase, and you want to run Metabase locally.
...
You can use any of the custom settings from [Customizing the Metabase Jetty Webserver](../configuring-metabase/customizing-jetty-webserver) by setting environment variables in your Podman run command.
