...
layout: new-docs
redirect_from:
    - /docs/v0.50/operations-guide/running-the-metabase-jar-file
...
If you are using a Pro or Enterprise version, be sure to [activate your license](../paid-features/activating-the-enterprise-edition).
...
If you are using a Pro or Enterprise version of Metabase, be sure to [activate your license](../paid-features/activating-the-enterprise-edition).
