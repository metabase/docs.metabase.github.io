...
layout: new-docs
redirect_from:
    - /v0.50/administration-guide/01-managing-databases
    - /v0.50/databases/connections/sql-server
    - /v0.50/administration-guide/databases/h2
    - /v0.50/databases/connections/h2
---
