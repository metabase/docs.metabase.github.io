...
layout: new-docs
redirect_from:
    - /docs/v0.50/administration-guide/01-managing-databases
    - /docs/v0.50/databases/connections/sql-server
    - /docs/v0.50/administration-guide/databases/h2
    - /docs/v0.50/databases/connections/h2
---
...
The databases listed below have official drivers maintained by the Metabase team. Customers on [Pro and Enterprise](/pricing) will get official support.
