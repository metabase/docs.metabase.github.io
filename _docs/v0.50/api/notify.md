...
category: Api
title: Notify
source_url: 'https://github.com/metabase/metabase/blob/master/docs/api/notify.md'
layout: new-docs
...
Notification about a potential schema change to one of our `Databases`.
  ...
  the `MB_API_KEY` [environment variable](/docs/latest/configuring-metabase/environment-variables#mb_api_key).
