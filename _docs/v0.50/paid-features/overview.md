...
layout: new-docs
redirect_from:
    - /docs/v0.50/enterprise-guide/start
---
...
- [Authenticating with SAML](../people-and-groups/authenticating-with-saml)
  ...
  - [Setting up SAML with Microsoft Entra ID](../people-and-groups/saml-azure)
...
- [Multiple domains with Google Sign-in](../people-and-groups/google-and-ldap#multiple-domains-for-google-sign-in)
...
- [Blocked view data permissions](../permissions/data#blocked-view-data-permission)
- [SQL snippet folder permissions](../permissions/snippets)
- [Application permissions](../permissions/application)
- [Download permissions](../permissions/data#download-results-permissions)
- [Connection impersonation](../permissions/data#impersonated-view-data-permission)
- [Database management permissions](../permissions/data#manage-database-permissions)
- [Table metadata management permissions](../permissions/data#manage-table-metadata-permissions)
...
- [Caching questions](../configuring-metabase/caching#question-caching-policy)
- [Caching dashboards](../configuring-metabase/caching#dashboard-caching-policy)
- [Caching databases](../configuring-metabase/caching#database-caching-policy)

## Model persistence for individual models

- [Toggle persistence for individual models](../data-modeling/model-persistence#turn-on-model-persistence-for-individual-models)

## Usage analytics

See how people are using your Metabase.

- [Metabase analytics](../usage-and-performance-tools/usage-analytics)
...
- [Deleting uploaded tables](../databases/uploads#deleting-tables-created-by-uploads)
