...
layout: new-docs
redirect_from:
    - /docs/v0.50/enterprise-guide/full-app-embedding
    - /docs/v0.50/embedding/full-app-embedding
---
...
1. Make sure you have a [license token](../paid-features/activating-the-enterprise-edition) for a [Pro or Enterprise plan](https://store.metabase.com/checkout/login-details).
