...
source_url: 'https://github.com/metabase/metabase/blob/master/docs/permissions/impersonation.md'
layout: new-docs
---
...
For more about how to set this up, check out [Use Impersonation to get row-level permissions with both GUI and SQL queries](/learn/permissions/impersonation).
...
- [Use Impersonation to get row-level permissions with both GUI and SQL queries](/learn/permissions/impersonation)
