...
See the [API changelog](./developers-guide/api-changelog).

## API endpoints

_* indicates endpoints used for features available on [Pro and Enterprise plans](/pricing)._
...
- [Google](api/google)
- [LDAP](api/ldap)
- [Legacy metric](api/legacy-metric)
- [LLM Auto-description*](api/ee/llm-auto-description)
