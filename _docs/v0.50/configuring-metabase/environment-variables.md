...
layout: new-docs
redirect_from:
    - /docs/v0.50/operations-guide/environment-variables
---
...
- Type: boolean
- Default: `true`
- [Exported as](../installation-and-operation/serialization): `enable-nested-queries`.
- [Configuration file name](./config-file): `enable-nested-queries`
...
- Type: boolean
- Default: `false`
- [Configuration file name](./config-file): `is-metabot-enabled`
...
- [Configuration file name](./config-file): `metabot-feedback-url`
...
- [Configuration file name](./config-file): `metabot-get-prompt-templates-url`
...
- Type: string
- Default: `null`
- [Configuration file name](./config-file): `openai-api-key`
...
- Type: string
- Default: `gpt-4-turbo-preview`
- [Configuration file name](./config-file): `openai-model`
...
- Type: string
- Default: `null`
- [Configuration file name](./config-file): `openai-organization`
