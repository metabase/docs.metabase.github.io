...
layout: new-docs
redirect_from:
    - /docs/v0.50/administration-guide/14-caching
    - /docs/v0.50/enterprise-guide/cache
---
...
On [Pro](/product/pro) and [Enterprise](/product/enterprise) plans, you can view querying and caching stats in the [Metabase analytics](../usage-and-performance-tools/usage-analytics) collection.
