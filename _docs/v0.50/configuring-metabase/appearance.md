...
layout: new-docs
redirect_from:
    - /v0.50/administration-guide/whitelabeling
    - /v0.50/enterprise-guide/whitelabeling
    - /v0.50/enterprise-guide/customize-embeds
    - /v0.50/embedding/whitelabeling
    - /v0.50/embedding/fonts
    - /v0.50/embedding/customize-embeds
---
