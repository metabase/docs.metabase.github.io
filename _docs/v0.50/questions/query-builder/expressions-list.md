...
layout: new-docs
redirect_from:
    - /docs/v0.50/users-guide/expressions-list
---
...
For more info, check out our page on [`CumulativeCount`](./expressions/cumulative).
...
For more info, check out our page on [`CumulativeSum`](./expressions/cumulative).
...
Check out our tutorial on [custom expressions in the query builder](/learn/questions/custom-expressions) to learn more.
