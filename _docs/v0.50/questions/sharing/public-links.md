...
layout: new-docs
redirect_from:
    - /docs/v0.50/administration-guide/12-public-links
    - /docs/v0.50/embedding/12-public-links
---
...
² Available on [Pro and Enterprise plans](/pricing) and hides the download button on questions only (not dashboards).
