...
layout: new-docs
redirect_from:
    - /docs/v0.50/users-guide/field-types
---
...
Marking fields as locations tell Metabase that it can use the field to display data on a [map chart](../questions/sharing/visualizations/map).

- **City**
- **Country**
- **Latitude**: Tells Metabase that the data could be plotted on a [pin map](../questions/sharing/visualizations/map).
...
Metabase will treat numeric field types as [numbers](../questions/sharing/visualizations/table#number-formatting-options).
...
See [Number formatting options](../questions/sharing/visualizations/table#number-formatting-options).
...
See [Date formatting options](../questions/sharing/visualizations/table#date-formatting-options).
