...
title: Docker
source_url: 'https://github.com/metabase/metabase/blob/master/docs/troubleshooting-guide/docker.md'
layout: docs
---
...
#### How to fix this:
Try to connect with `mysql` or `psql` commands with the connection string parameters you are passing in via the environment variables: see [here](../operations-guide/start.html#configuring-the-metabase-application-database) for help.
...
#### How to fix this:
Make sure you are giving the container a persistent volume as described [here](../operations-guide/running-metabase-on-docker.html#mounting-a-mapped-file-storage-volume)
